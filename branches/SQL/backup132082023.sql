DROP VIEW SINDICATO_132.V_TABLAS_COLUMNAS;

/* Formatted on 8/2/2023 9:28:44 PM (QP5 v5.136.908.31019) */
CREATE OR REPLACE FORCE VIEW SINDICATO_132.V_TABLAS_COLUMNAS
(
   ID_TABLA,
   TABLA,
   COLUMNA,
...
AS
   SELECT u.COLUMN_ID,
    ...
    WHERE     u.table_name = a.table_NAME
          AND a.owner = 'SINDICATO_132'
          AND a.column_name = u.column_name;
DROP TABLE SINDICATO_132.BACKUP_SINDICATO CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.BACKUP_SINDICATO
(
...
ALTER TABLE SINDICATO_132.SD_AUTOS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_AUTOS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_AUTOS
(
...
ALTER TABLE SINDICATO_132.SD_AUX_LOG_ERRORES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_AUX_LOG_ERRORES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_AUX_LOG_ERRORES
(
  ID_LOG      NUMBER(12),
  LOGIN_USR   VARCHAR2(20 BYTE),
  FECHA       DATE,
...
ALTER TABLE SINDICATO_132.SD_CAJAS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_CAJAS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_CAJAS
(
...
DROP TABLE SINDICATO_132.SD_CHOFERES_X CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_CHOFERES_X
(
...
ALTER TABLE SINDICATO_132.SD_CIERRES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_CIERRES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_CIERRES
(
...
ALTER TABLE SINDICATO_132.SD_CIERRES_CAJAS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_CIERRES_CAJAS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_CIERRES_CAJAS
(
  ID_CIERRE    NUMBER(7)                        NOT NULL,
  CODIGO       VARCHAR2(50 BYTE)                NOT NULL,
  FECHA_INI    DATE                             NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_DESCUENTOS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_DESCUENTOS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_DESCUENTOS
(
...
ALTER TABLE SINDICATO_132.SD_DETALLE_CIERRES_AHORRO
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_DETALLE_CIERRES_AHORRO CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_DETALLE_CIERRES_AHORRO
(
...
ALTER TABLE SINDICATO_132.SD_DETALLE_CIERRES_CAJA
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_DETALLE_CIERRES_CAJA CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_DETALLE_CIERRES_CAJA
(
  ID_DETALLE   NUMBER(7)                        NOT NULL,
  ID_CIERRE    NUMBER(7)                        NOT NULL,
  ID_CAJA      NUMBER(7)                        NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_DETALLE_HOJAS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_DETALLE_HOJAS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_DETALLE_HOJAS
(
  ID_DETALLE   NUMBER(7)                        NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_FONDO_EMERGENCIAS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_FONDO_EMERGENCIAS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_FONDO_EMERGENCIAS
(
...
(
  ...
  SALDO_A_FAVOR       NUMBER(15,2),
  SALDO_POR_COBRAR    NUMBER(15,2),
  OBSERVACION_CIERRE  VARCHAR2(255 BYTE)
)
TABLESPACE USERS
PCTUSED    0
PCTFREE    10
...
ALTER TABLE SINDICATO_132.SD_HIST_EDICION_DATOS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_HIST_EDICION_DATOS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_HIST_EDICION_DATOS
(
...
ALTER TABLE SINDICATO_132.SD_IMAGENES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_IMAGENES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_IMAGENES
(
...
ALTER TABLE SINDICATO_132.SD_IMPRESIONES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_IMPRESIONES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_IMPRESIONES
(
...
ALTER TABLE SINDICATO_132.SD_INGRESOS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_INGRESOS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_INGRESOS
(
...
DROP TABLE SINDICATO_132.SD_JOBS_BACKUP CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_JOBS_BACKUP
(
...
ALTER TABLE SINDICATO_132.SD_KARDEX_EFECTIVO
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_KARDEX_EFECTIVO CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_KARDEX_EFECTIVO
(
...
ALTER TABLE SINDICATO_132.SD_LINEAS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_LINEAS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_LINEAS
(
...
ALTER TABLE SINDICATO_132.SD_LISTAS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_LISTAS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_LISTAS
(
...
COMMENT ON TABLE SINDICATO_132.SD_LISTAS IS 'Tabla de parametros. Definicion de cabecera de listas de parametros predefinidos.';

COMMENT ON COLUMN SINDICATO_132.SD_LISTAS.ID_LISTA IS 'Identificador unico para cada registro';

COMMENT ON COLUMN SINDICATO_132.SD_LISTAS.LISTA IS 'Nombre del parametro de lista';

COMMENT ON COLUMN SINDICATO_132.SD_LISTAS.DESCRIPCION IS 'Descripcion del elemento';

COMMENT ON COLUMN SINDICATO_132.SD_LISTAS.TAM_LIMITE IS 'Cantidad de caracteres o digitos que puede contener';

COMMENT ON COLUMN SINDICATO_132.SD_LISTAS.TIPO_VALOR IS 'Tipo de valor que acepta (CADENA o NUMERICO)';

COMMENT ON COLUMN SINDICATO_132.SD_LISTAS.MAYUS_MINUS IS 'Indica si se aceptan solo mayusculas (MAYUS) o ambos (MINUS)';

COMMENT ON COLUMN SINDICATO_132.SD_LISTAS.ESTADO IS 'Estado en el que se encuentra el documento';


ALTER TABLE SINDICATO_132.SD_LISTAS_ITEMS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_LISTAS_ITEMS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_LISTAS_ITEMS
(
  ID_TABLA  NUMBER(7)                           NOT NULL,
  ID_PADRE  NUMBER(7),
  ID_LISTA  NUMBER(7)                           NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_MENU_OPCIONES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_MENU_OPCIONES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_MENU_OPCIONES
(
...
ALTER TABLE SINDICATO_132.SD_MOVILES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_MOVILES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_MOVILES
(
...
ALTER TABLE SINDICATO_132.SD_OBLIGACIONES_HOJA
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_OBLIGACIONES_HOJA CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_OBLIGACIONES_HOJA
(
...
ALTER TABLE SINDICATO_132.SD_PARADAS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_PARADAS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_PARADAS
(
...
ALTER TABLE SINDICATO_132.SD_PARAMETROS_LINEA
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_PARAMETROS_LINEA CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_PARAMETROS_LINEA
(
...
DROP TABLE SINDICATO_132.SD_PARAM_CANT_HOJAS_MES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_PARAM_CANT_HOJAS_MES
(
  ID_PARAMETRO  NUMBER(7)                       NOT NULL,
  FECHA         DATE                            NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_PERFILES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_PERFILES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_PERFILES
(
...
COMMENT ON COLUMN SINDICATO_132.SD_PERFILES.NOMBRE IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_PERFILES.DESCRIPCION IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_PERFILES.ESTADO IS 'grid , lista';


ALTER TABLE SINDICATO_132.SD_PERFILES_OPCIONES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_PERFILES_OPCIONES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_PERFILES_OPCIONES
(
...
ALTER TABLE SINDICATO_132.SD_SOCIOS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_SOCIOS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_SOCIOS
(
  ID_SOCIO          NUMBER(7)                   NOT NULL,
...
COMMENT ON COLUMN SINDICATO_132.SD_SOCIOS.NRO_SOCIO IS 'grid ';

COMMENT ON COLUMN SINDICATO_132.SD_SOCIOS.NOMBRE IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_SOCIOS.APELLIDO_PATERNO IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_SOCIOS.APELLIDO_MATERNO IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_SOCIOS.NRO_LICENCIA IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_SOCIOS.CATEGORIA_LIC IS 'grid  , lista';

COMMENT ON COLUMN SINDICATO_132.SD_SOCIOS.CI IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_SOCIOS.EXPEDIDO IS 'grid ,  lista';

COMMENT ON COLUMN SINDICATO_132.SD_SOCIOS.FECHA_NAC IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_SOCIOS.DOMICILIO IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_SOCIOS.ESTADO_CIVIL IS 'grid , lista';


DROP TABLE SINDICATO_132.SD_SOCIOS_X CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_SOCIOS_X
(
  ID_SOCIO          NUMBER(7)                   NOT NULL,
  NRO_SOCIO         NUMBER(7)                   NOT NULL,
  NOMBRE            VARCHAR2(200 BYTE)          NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_SOCIO_DESEMPENOS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_SOCIO_DESEMPENOS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_SOCIO_DESEMPENOS
(
...
COMMENT ON COLUMN SINDICATO_132.SD_SOCIO_DESEMPENOS.CARGO IS 'lista , grid';

COMMENT ON COLUMN SINDICATO_132.SD_SOCIO_DESEMPENOS.OBSERVACION IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_SOCIO_DESEMPENOS.FECHA_DESDE IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_SOCIO_DESEMPENOS.FECHA_HASTA IS 'grid';


ALTER TABLE SINDICATO_132.SD_SOCIO_MOVILES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_SOCIO_MOVILES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_SOCIO_MOVILES
(
  ID_SOCIO_MOVIL  NUMBER(7)                     NOT NULL,
  ID_SOCIO        NUMBER(7)                     NOT NULL,
  ID_MOVIL        NUMBER(7)                     NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_SOCIO_MOVIL_AUTOS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_SOCIO_MOVIL_AUTOS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_SOCIO_MOVIL_AUTOS
(
...
ALTER TABLE SINDICATO_132.SD_SOC_MOV_OBLIG
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_SOC_MOV_OBLIG CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_SOC_MOV_OBLIG
(
...
ALTER TABLE SINDICATO_132.SD_TIPOS_EGRESOS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_TIPOS_EGRESOS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_TIPOS_EGRESOS
(
...
ALTER TABLE SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO
(
  ID_TIPO      NUMBER(7)                        NOT NULL,
  ID_CAJA      NUMBER(7)                        NOT NULL,
  NOMBRE       VARCHAR2(255 BYTE),
...
ALTER TABLE SINDICATO_132.SD_TIPOS_PRESTAMOS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_TIPOS_PRESTAMOS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_TIPOS_PRESTAMOS
(
  ID_TIPO           NUMBER(7)                   NOT NULL,
  ID_CAJA           NUMBER(7)                   NOT NULL,
  NOMBRE            VARCHAR2(255 BYTE),
  ...
  DIAS_ESPERA_MORA  INTEGER                     NOT NULL
)
TABLESPACE USERS
PCTUSED    0
PCTFREE    10
...
ALTER TABLE SINDICATO_132.SD_TRANSFERENCIAS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_TRANSFERENCIAS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_TRANSFERENCIAS
(
...
ALTER TABLE SINDICATO_132.SD_TRANSFERENCIAS_HOJAS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_TRANSFERENCIAS_HOJAS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_TRANSFERENCIAS_HOJAS
(
...
ALTER TABLE SINDICATO_132.SD_USUARIOS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_USUARIOS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_USUARIOS
(
  ID_USUARIO  NUMBER(5)                         NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_VENTA_HOJAS_CONTROL
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_VENTA_HOJAS_CONTROL CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_VENTA_HOJAS_CONTROL
(
  ID_VENTA     NUMBER(7)                        NOT NULL,
  ID_PARADA    NUMBER(7)                        NOT NULL,
  NRO_MOVIL    NUMBER(7)                        NOT NULL,
...
CREATE UNIQUE INDEX SINDICATO_132.PK_SG_LISTAS ON SINDICATO_132.SD_LISTAS
(ID_LISTA)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_AUTOS_PK ON SINDICATO_132.SD_AUTOS
(ID_AUTO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_AUX_LOG_ERRORES_PK ON SINDICATO_132.SD_AUX_LOG_ERRORES
(ID_LOG)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_CAJAS_PK ON SINDICATO_132.SD_CAJAS
(ID_CAJA)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_CIERRES_CAJAS_PK ON SINDICATO_132.SD_CIERRES_CAJAS
(ID_CIERRE)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_CIERRES_PK ON SINDICATO_132.SD_CIERRES
(ID_CIERRE)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_DESCUENTOS_PK ON SINDICATO_132.SD_DESCUENTOS
(ID_DESCUENTO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_DETALLE_CIERRES_AHORRO_PK ON SINDICATO_132.SD_DETALLE_CIERRES_AHORRO
(ID_DETALLE)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_DETALLE_CIERRES_CAJA_PK ON SINDICATO_132.SD_DETALLE_CIERRES_CAJA
(ID_DETALLE)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_DETALLE_HOJAS_PK ON SINDICATO_132.SD_DETALLE_HOJAS
(ID_DETALLE)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_FONDO_EMERGENCIAS_PK ON SINDICATO_132.SD_FONDO_EMERGENCIAS
(ID_FONDO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_HIST_EDICION_DATOS_PK ON SINDICATO_132.SD_HIST_EDICION_DATOS
(ID_HIST)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_IMAGENES_PK ON SINDICATO_132.SD_IMAGENES
(ID_IMG)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_IMPRESIONES_PK ON SINDICATO_132.SD_IMPRESIONES
(ID_IMPRESION)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_INGRESOS_PK ON SINDICATO_132.SD_INGRESOS
(ID_INGRESO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_KARDEX_EFECTIVO_PK ON SINDICATO_132.SD_KARDEX_EFECTIVO
(ID_KARDEX)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_LINEAS_PK ON SINDICATO_132.SD_LINEAS
(ID_LINEA)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_LISTAS_ITEMS_PK ON SINDICATO_132.SD_LISTAS_ITEMS
(ID_TABLA)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_MENU_OPCIONES_PK ON SINDICATO_132.SD_MENU_OPCIONES
(ID_OPC)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_MOVILES_PK ON SINDICATO_132.SD_MOVILES
(ID_MOVIL)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_OBLIGACIONES_HOJA_PK ON SINDICATO_132.SD_OBLIGACIONES_HOJA
(ID_OBLIGACION)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_PARADAS_PK ON SINDICATO_132.SD_PARADAS
(ID_PARADA)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_PARAMETROS_LINEA_PK ON SINDICATO_132.SD_PARAMETROS_LINEA
(ID_PARAMETRO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_PERFILES_OPCIONES_PK ON SINDICATO_132.SD_PERFILES_OPCIONES
(ID_PRF_OPC)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_PERFILES_PK ON SINDICATO_132.SD_PERFILES
(ID_PERFIL)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_SOCIOS_PK ON SINDICATO_132.SD_SOCIOS
(ID_SOCIO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_SOCIOS_U01 ON SINDICATO_132.SD_SOCIOS
(NRO_SOCIO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_SOCIO_DESEMPENOS_PK ON SINDICATO_132.SD_SOCIO_DESEMPENOS
(ID_DESEMPENO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_SOCIO_MOVILES_PK ON SINDICATO_132.SD_SOCIO_MOVILES
(ID_SOCIO_MOVIL)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_SOCIO_MOVIL_AUTOS_PK ON SINDICATO_132.SD_SOCIO_MOVIL_AUTOS
(ID_SOCIO_MOVIL_AUTO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_SOC_MOV_OBLIG_PK ON SINDICATO_132.SD_SOC_MOV_OBLIG
(ID_SOC_MOV_OBLIG)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_TIPOS_EGRESOS_PK ON SINDICATO_132.SD_TIPOS_EGRESOS
(ID_TIPO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO_PK ON SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO
(ID_TIPO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_TIPOS_PRESTAMOS_PK ON SINDICATO_132.SD_TIPOS_PRESTAMOS
(ID_TIPO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_TRANSFERENCIAS_HOJAS_PK ON SINDICATO_132.SD_TRANSFERENCIAS_HOJAS
(ID_TRANSF)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_TRANSFERENCIAS_PK ON SINDICATO_132.SD_TRANSFERENCIAS
(ID_TRANSFERENCIA)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_USUARIOS_PK ON SINDICATO_132.SD_USUARIOS
(ID_USUARIO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_VENTA_HOJAS_CONTROL_PK ON SINDICATO_132.SD_VENTA_HOJAS_CONTROL
(ID_VENTA)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
ALTER TABLE SINDICATO_132.SD_AMORTIZACIONES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_AMORTIZACIONES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_AMORTIZACIONES
(
...
ALTER TABLE SINDICATO_132.SD_CHOFERES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_CHOFERES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_CHOFERES
(
  ID_CHOFER         NUMBER(7)                   NOT NULL,
  NRO_CHOFER        NUMBER(7)                   NOT NULL,
  NOMBRE            VARCHAR2(200 BYTE)          NOT NULL,
...
COMMENT ON COLUMN SINDICATO_132.SD_CHOFERES.NRO_CHOFER IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_CHOFERES.NOMBRE IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_CHOFERES.APELLIDO_PATERNO IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_CHOFERES.APELLIDO_MATERNO IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_CHOFERES.NRO_LICENCIA IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_CHOFERES.CATEGORIA_LIC IS 'grid , lista';

COMMENT ON COLUMN SINDICATO_132.SD_CHOFERES.CI IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_CHOFERES.EXPEDIDO IS 'grid  lista';

COMMENT ON COLUMN SINDICATO_132.SD_CHOFERES.FECHA_NAC IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_CHOFERES.FECHA_INGRESO IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_CHOFERES.DOMICILIO IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_CHOFERES.OBSERVACION IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_CHOFERES.ESTADO_CIVIL IS 'grid  lista';

COMMENT ON COLUMN SINDICATO_132.SD_CHOFERES.ID_SOCIO IS 'lista';


ALTER TABLE SINDICATO_132.SD_CIERRES_PARADA
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_CIERRES_PARADA CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_CIERRES_PARADA
(
  ID_CIERRE      NUMBER(7)                      NOT NULL,
  ID_PARADA      NUMBER(7)                      NOT NULL,
  FECHA_INI      DATE                           NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_DEPOSITO_FE
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_DEPOSITO_FE CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_DEPOSITO_FE
(
...
ALTER TABLE SINDICATO_132.SD_DESCUENTOS_SOCIO
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_DESCUENTOS_SOCIO CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_DESCUENTOS_SOCIO
(
...
ALTER TABLE SINDICATO_132.SD_DETALLE_CIERRE_GESTION
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_DETALLE_CIERRE_GESTION CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_DETALLE_CIERRE_GESTION
(
  ID_DETALLE                 NUMBER(7),
  ID_GESTION                 NUMBER(7)          NOT NULL,
  DETALLE                    VARCHAR2(255 BYTE) NOT NULL,
  TIPO                       VARCHAR2(255 BYTE) NOT NULL,
  CANT_PREST_CANCELADOS      NUMBER(7)          NOT NULL,
  CANT_PREST_POR_COBRAR      NUMBER(7)          NOT NULL,
  TOTAL_PRESTAMO             NUMBER(15,2)       NOT NULL,
  TOTAL_INTERES              NUMBER(15,2)       NOT NULL,
  TOTAL_MORAS                NUMBER(15,2)       NOT NULL,
  TOTAL_CONDONACION_INTERES  NUMBER(15,2)       NOT NULL,
  TOTAL_CANCELADO            NUMBER(15,2)       NOT NULL,
  DEBE                       NUMBER(15,2)       NOT NULL,
  HABER                      NUMBER(15,2)       NOT NULL,
  FECHA_REG                  DATE               NOT NULL,
  TOTAL_MORA_CANCELADO       NUMBER(15,2),
  TOTAL_INTERES_CANCELADO    NUMBER(15,2)
)
TABLESPACE USERS
PCTUSED    0
PCTFREE    10
...
ALTER TABLE SINDICATO_132.SD_DETALLE_CIERRE_PARADA
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_DETALLE_CIERRE_PARADA CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_DETALLE_CIERRE_PARADA
(
  ID_DETALLE  NUMBER(7)                         NOT NULL,
  ID_CIERRE   NUMBER(7)                         NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_DETALLE_PERIODO_SOCIO
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_DETALLE_PERIODO_SOCIO CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_DETALLE_PERIODO_SOCIO
(
  ID_DETALLE                NUMBER(7)           NOT NULL,
  ID_CIERRE                 NUMBER(7)           NOT NULL,
  ID_SOCIO                  NUMBER(7)           NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_DOCUMENTACIONES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_DOCUMENTACIONES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_DOCUMENTACIONES
(
...
COMMENT ON COLUMN SINDICATO_132.SD_DOCUMENTACIONES.DOCUMENTACION IS 'grid , lista';

COMMENT ON COLUMN SINDICATO_132.SD_DOCUMENTACIONES.TIPO IS 'lista';

COMMENT ON COLUMN SINDICATO_132.SD_DOCUMENTACIONES.OBSERVACION IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_DOCUMENTACIONES.FECHA IS 'grid';


ALTER TABLE SINDICATO_132.SD_EGRESOS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_EGRESOS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_EGRESOS
(
...
ALTER TABLE SINDICATO_132.SD_FAMILIARES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_FAMILIARES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_FAMILIARES
(
...
COMMENT ON COLUMN SINDICATO_132.SD_FAMILIARES.NOMBRE IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_FAMILIARES.CI IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_FAMILIARES.EXPEDIDO IS 'lista';

COMMENT ON COLUMN SINDICATO_132.SD_FAMILIARES.FECHA_NAC IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_FAMILIARES.PARENTESCO IS 'grid , lista';

COMMENT ON COLUMN SINDICATO_132.SD_FAMILIARES.OBSERVACION IS 'grid';


ALTER TABLE SINDICATO_132.SD_GARANTES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_GARANTES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_GARANTES
(
...
ALTER TABLE SINDICATO_132.SD_HOJAS_CONTROL
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_HOJAS_CONTROL CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_HOJAS_CONTROL
(
...
ALTER TABLE SINDICATO_132.SD_HOJAS_LINEA
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_HOJAS_LINEA CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_HOJAS_LINEA
(
  ID_HOJA      NUMBER(7)                        NOT NULL,
  ID_LINEA     NUMBER(7)                        NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_INGRESOS_POR_SOCIOS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_INGRESOS_POR_SOCIOS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_INGRESOS_POR_SOCIOS
(
  ID_INGRESO       NUMBER(7)                    NOT NULL,
  ID_SOCIO_MOVIL   NUMBER(7)                    NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_INGRESOS_SOCIO
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_INGRESOS_SOCIO CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_INGRESOS_SOCIO
(
  ID_INGRESO   NUMBER(7)                        NOT NULL,
  ID_SOCIO     NUMBER(7)                        NOT NULL,
  NRO_RECIBO   NUMBER(7)                        NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_KARDEX_FM
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_KARDEX_FM CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_KARDEX_FM
(
  ID_KARDEX    NUMBER(7)                        NOT NULL,
  ID_CHOFER    NUMBER(7)                        NOT NULL,
  OPERACION    VARCHAR2(250 BYTE)               NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_KARDEX_HOJAS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_KARDEX_HOJAS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_KARDEX_HOJAS
(
  ID_KARDEX          NUMBER(7)                  NOT NULL,
  ID_SOCIO_MOVIL     NUMBER(7)                  NOT NULL,
  MES                DATE                       NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_KARDEX_SOCIO
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_KARDEX_SOCIO CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_KARDEX_SOCIO
(
  ID_KARDEX     NUMBER(7)                       NOT NULL,
  ID_SOCIO      NUMBER(7)                       NOT NULL,
  ID_OPERACION  NUMBER(7)                       NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_KARDEX_SOCIO_DEBE
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_KARDEX_SOCIO_DEBE CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_KARDEX_SOCIO_DEBE
(
  ID_KARDEX     NUMBER(7)                       NOT NULL,
  ID_SOCIO      NUMBER(7)                       NOT NULL,
  ID_OPERACION  NUMBER(7)                       NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_KARDEX_SOCIO_MOVIL
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_KARDEX_SOCIO_MOVIL CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_KARDEX_SOCIO_MOVIL
(
  ID_KARDEX       NUMBER(7)                     NOT NULL,
  ID_SOCIO_MOVIL  NUMBER(7)                     NOT NULL,
  ID_OPERACION    NUMBER(7)                     NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_OBLIGACIONES_SOCIO
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_OBLIGACIONES_SOCIO CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_OBLIGACIONES_SOCIO
(
  ID_OBLIGACION  NUMBER(7)                      NOT NULL,
  ID_SOCIO       NUMBER(7)                      NOT NULL,
  OBLIGACION     VARCHAR2(250 BYTE)             NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_OTRAS_OBLIGACIONES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_OTRAS_OBLIGACIONES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_OTRAS_OBLIGACIONES
(
  ID_OBLIGACION  NUMBER(7)                      NOT NULL,
  ID_SOCIO       NUMBER(7)                      NOT NULL,
  ID_CIERRE      NUMBER(7)                      NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_PERMISOS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_PERMISOS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_PERMISOS
(
...
ALTER TABLE SINDICATO_132.SD_PRESTAMOS_POR_SOCIOS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_PRESTAMOS_POR_SOCIOS CASCADE CONSTRAINTS;
...
(
  ...
  ID_GESTION           NUMBER(7),
  NUMERO               NUMBER(7),
  CONDONACION_INTERES  NUMBER(15,2)             DEFAULT 0                     NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_REGULARIZACIONES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_REGULARIZACIONES CASCADE CONSTRAINTS;
...
ALTER TABLE SINDICATO_132.SD_RETIRO_FE
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_RETIRO_FE CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_RETIRO_FE
(
...
ALTER TABLE SINDICATO_132.SD_RETIRO_SOCIO
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_RETIRO_SOCIO CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_RETIRO_SOCIO
(
  ID_RETIRO    NUMBER(7)                        NOT NULL,
  ID_SOCIO     NUMBER(7)                        NOT NULL,
  NRO_RECIBO   NUMBER(7)                        NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_RETIRO_SOCIO_MOVIL
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_RETIRO_SOCIO_MOVIL CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_RETIRO_SOCIO_MOVIL
(
  ID_RETIRO       NUMBER(7)                     NOT NULL,
  ID_SOCIO_MOVIL  NUMBER(7)                     NOT NULL,
  ID_CAJA         NUMBER(7)                     NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_TRANSF_HOJA_DET
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_TRANSF_HOJA_DET CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_TRANSF_HOJA_DET
(
...
ALTER TABLE SINDICATO_132.SD_VENTA_HOJAS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_VENTA_HOJAS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_VENTA_HOJAS
(
  ID_VENTA   NUMBER(7)                          NOT NULL,
  ID_HOJA    NUMBER(7)                          NOT NULL,
  FECHA_REG  DATE,
...
CREATE UNIQUE INDEX SINDICATO_132.SD_AMORTIZACIONES_PK ON SINDICATO_132.SD_AMORTIZACIONES
(ID_AMORTIZACION)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_CHOFERES_PK ON SINDICATO_132.SD_CHOFERES
(ID_CHOFER)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_CIERRES_PARADA_PK ON SINDICATO_132.SD_CIERRES_PARADA
(ID_CIERRE)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_DEPOSITO_FE_PK ON SINDICATO_132.SD_DEPOSITO_FE
(ID_DEPOSITO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_DESCUENTOS_SOCIO_PK ON SINDICATO_132.SD_DESCUENTOS_SOCIO
(ID_DESCUENTO_SOCIO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_DETALLE_CIERRE_GESTION_PK ON SINDICATO_132.SD_DETALLE_CIERRE_GESTION
(ID_DETALLE)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_DETALLE_CIERRE_PARADA_PK ON SINDICATO_132.SD_DETALLE_CIERRE_PARADA
(ID_DETALLE)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_DETALLE_PERIODO_SOCIO_PK ON SINDICATO_132.SD_DETALLE_PERIODO_SOCIO
(ID_DETALLE)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_DOCUMENTACIONES_PK ON SINDICATO_132.SD_DOCUMENTACIONES
(ID_DOCUMENTACION)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_EGRESOS_PK ON SINDICATO_132.SD_EGRESOS
(ID_EGRESO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_FAMILIARES_PK ON SINDICATO_132.SD_FAMILIARES
(ID_FAMILIAR)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_GARANTES_PK ON SINDICATO_132.SD_GARANTES
(ID_GARANTE)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_HOJAS_CONTROL_PK ON SINDICATO_132.SD_HOJAS_CONTROL
(ID_HOJA)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_HOJAS_LINEA_PK ON SINDICATO_132.SD_HOJAS_LINEA
(ID_HOJA)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_INGRESOS_POR_SOCIOS_PK ON SINDICATO_132.SD_INGRESOS_POR_SOCIOS
(ID_INGRESO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_INGRESOS_SOCIO_PK ON SINDICATO_132.SD_INGRESOS_SOCIO
(ID_INGRESO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_KARDEX_FM_PK ON SINDICATO_132.SD_KARDEX_FM
(ID_KARDEX)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_KARDEX_HOJAS_PK ON SINDICATO_132.SD_KARDEX_HOJAS
(ID_KARDEX)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_KARDEX_SOCIO_DEBE_PK ON SINDICATO_132.SD_KARDEX_SOCIO_DEBE
(ID_KARDEX)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_KARDEX_SOCIO_MOVIL_PK ON SINDICATO_132.SD_KARDEX_SOCIO_MOVIL
(ID_KARDEX)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_KARDEX_SOCIO_PK ON SINDICATO_132.SD_KARDEX_SOCIO
(ID_KARDEX)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_OBLIGACIONES_SOCIO_PK ON SINDICATO_132.SD_OBLIGACIONES_SOCIO
(ID_OBLIGACION)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_OTRAS_OBLIGACIONES_PK ON SINDICATO_132.SD_OTRAS_OBLIGACIONES
(ID_OBLIGACION)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_PERMISOS_PK ON SINDICATO_132.SD_PERMISOS
(ID_PERMISO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_PRESTAMOS_POR_SOCIOS_PK ON SINDICATO_132.SD_PRESTAMOS_POR_SOCIOS
(ID_PRESTAMO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_REGULARIZACIONES_PK ON SINDICATO_132.SD_REGULARIZACIONES
(ID_REGULACION)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_RETIRO_FE_PK ON SINDICATO_132.SD_RETIRO_FE
(ID_RETIRO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_RETIRO_SOCIO_MOVIL_PK ON SINDICATO_132.SD_RETIRO_SOCIO_MOVIL
(ID_RETIRO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_RETIRO_SOCIO_PK ON SINDICATO_132.SD_RETIRO_SOCIO
(ID_RETIRO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_TRANSF_HOJA_DET_PK ON SINDICATO_132.SD_TRANSF_HOJA_DET
(ID_DETALLE)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_VENTA_HOJAS_PK ON SINDICATO_132.SD_VENTA_HOJAS
(ID)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
ALTER TABLE SINDICATO_132.SD_ANTECEDENTES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_ANTECEDENTES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_ANTECEDENTES
(
...
COMMENT ON COLUMN SINDICATO_132.SD_ANTECEDENTES.MOTIVO IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_ANTECEDENTES.OBSERVACION IS 'grid';

COMMENT ON COLUMN SINDICATO_132.SD_ANTECEDENTES.FECHA IS 'grid';


ALTER TABLE SINDICATO_132.SD_ANULACIONES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_ANULACIONES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_ANULACIONES
(
...
ALTER TABLE SINDICATO_132.SD_DETALLES_HOJAS_CONTROL
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_DETALLES_HOJAS_CONTROL CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_DETALLES_HOJAS_CONTROL
(
...
ALTER TABLE SINDICATO_132.SD_DETALLES_REGULARIZACIONES
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_DETALLES_REGULARIZACIONES CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_DETALLES_REGULARIZACIONES
(
  ID_DETALLE     NUMBER(12)                     NOT NULL,
  ID_REGULACION  NUMBER(7)                      NOT NULL,
  ID_CAJA        NUMBER(7)                      NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_KARDEX_OBLIGACION
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_KARDEX_OBLIGACION CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_KARDEX_OBLIGACION
(
  ID_KARDEX         NUMBER(7)                   NOT NULL,
  ID_OBLIGACION     NUMBER(7)                   NOT NULL,
...
ALTER TABLE SINDICATO_132.SD_PLAN_DE_PAGO
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_PLAN_DE_PAGO CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_PLAN_DE_PAGO
(
  ...
  FECHA_REG        DATE,
  LOGIN_USR        VARCHAR2(20 BYTE),
  DIAS_RETRASO     NUMBER                       DEFAULT 0                     NOT NULL,
  ID_PAGO          NUMBER(7),
  CONDONACION      NUMBER(15,2)                 NOT NULL,
  MORA_A_PAGAR     NUMBER(15,2)                 NOT NULL
)
TABLESPACE USERS
PCTUSED    0
PCTFREE    10
...
ALTER TABLE SINDICATO_132.SD_PRESTAMOS_MORA
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_PRESTAMOS_MORA CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_PRESTAMOS_MORA
(
...
CREATE UNIQUE INDEX SINDICATO_132.SD_ANTECEDENTES_PK ON SINDICATO_132.SD_ANTECEDENTES
(ID_ANTECEDENTE)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_ANULACIONES_PK ON SINDICATO_132.SD_ANULACIONES
(ID_ANULACION)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_DETALLES_HOJAS_CONTROL_PK ON SINDICATO_132.SD_DETALLES_HOJAS_CONTROL
(ID_DETALLE)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_DETALLES_REGULARIZACIONESPK ON SINDICATO_132.SD_DETALLES_REGULARIZACIONES
(ID_DETALLE)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_KARDEX_OBLIGACION_PK ON SINDICATO_132.SD_KARDEX_OBLIGACION
(ID_KARDEX)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_PLAN_DE_PAGO_PK ON SINDICATO_132.SD_PLAN_DE_PAGO
(ID_PLAN)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE UNIQUE INDEX SINDICATO_132.SD_PRESTAMOS_MORA_PK ON SINDICATO_132.SD_PRESTAMOS_MORA
(ID_MORA)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
ALTER TABLE SINDICATO_132.SD_PAGO_DE_PRESTAMOS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO_132.SD_PAGO_DE_PRESTAMOS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO_132.SD_PAGO_DE_PRESTAMOS
(
  ...
  FECHA_REG          DATE,
  LOGIN_USR          VARCHAR2(20 BYTE),
  TOTAL_CONDONACION  NUMBER(15,2)               DEFAULT 0                     NOT NULL,
  ID_PLAN            NUMBER(7),
  ID_MORA            NUMBER(7),
  IMPORTE_MORA       NUMBER(15,2)               DEFAULT 0                     NOT NULL,
...
CREATE UNIQUE INDEX SINDICATO_132.SD_PAGO_DE_PRESTAMOS_PK ON SINDICATO_132.SD_PAGO_DE_PRESTAMOS
(ID_PAGO)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
ALTER TABLE SINDICATO_132.SD_AUTOS ADD (
...
ALTER TABLE SINDICATO_132.SD_AUX_LOG_ERRORES ADD (
...
ALTER TABLE SINDICATO_132.SD_CAJAS ADD (
...
ALTER TABLE SINDICATO_132.SD_CIERRES ADD (
...
ALTER TABLE SINDICATO_132.SD_CIERRES_CAJAS ADD (
...
ALTER TABLE SINDICATO_132.SD_DESCUENTOS ADD (
...
ALTER TABLE SINDICATO_132.SD_DETALLE_CIERRES_AHORRO ADD (
...
ALTER TABLE SINDICATO_132.SD_DETALLE_CIERRES_CAJA ADD (
...
ALTER TABLE SINDICATO_132.SD_DETALLE_HOJAS ADD (
...
ALTER TABLE SINDICATO_132.SD_FONDO_EMERGENCIAS ADD (
...
ALTER TABLE SINDICATO_132.SD_HIST_EDICION_DATOS ADD (
...
ALTER TABLE SINDICATO_132.SD_IMAGENES ADD (
...
ALTER TABLE SINDICATO_132.SD_IMPRESIONES ADD (
...
ALTER TABLE SINDICATO_132.SD_INGRESOS ADD (
...
ALTER TABLE SINDICATO_132.SD_KARDEX_EFECTIVO ADD (
...
ALTER TABLE SINDICATO_132.SD_LINEAS ADD (
...
ALTER TABLE SINDICATO_132.SD_LISTAS ADD (
...
ALTER TABLE SINDICATO_132.SD_LISTAS_ITEMS ADD (
  CONSTRAINT SG_LISTAS_ITEMS_PK
 PRIMARY KEY
 (ID_TABLA));


ALTER TABLE SINDICATO_132.SD_MENU_OPCIONES ADD (
  CONSTRAINT SG_MENU_OPCIONES_PK
 PRIMARY KEY
 (ID_OPC));


ALTER TABLE SINDICATO_132.SD_MOVILES ADD (
...
ALTER TABLE SINDICATO_132.SD_OBLIGACIONES_HOJA ADD (
...
ALTER TABLE SINDICATO_132.SD_PARADAS ADD (
...
ALTER TABLE SINDICATO_132.SD_PARAMETROS_LINEA ADD (
...
ALTER TABLE SINDICATO_132.SD_PERFILES ADD (
  CONSTRAINT SG_PERFILES_PK
 PRIMARY KEY
 (ID_PERFIL));


ALTER TABLE SINDICATO_132.SD_PERFILES_OPCIONES ADD (
  CONSTRAINT SG_PERFILES_OPCIONES_PK
 PRIMARY KEY
 (ID_PRF_OPC));


ALTER TABLE SINDICATO_132.SD_SOCIOS ADD (
...
ALTER TABLE SINDICATO_132.SD_SOCIO_DESEMPENOS ADD (
...
ALTER TABLE SINDICATO_132.SD_SOCIO_MOVILES ADD (
...
ALTER TABLE SINDICATO_132.SD_SOCIO_MOVIL_AUTOS ADD (
...
ALTER TABLE SINDICATO_132.SD_SOC_MOV_OBLIG ADD (
...
ALTER TABLE SINDICATO_132.SD_TIPOS_EGRESOS ADD (
...
ALTER TABLE SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO ADD (
...
ALTER TABLE SINDICATO_132.SD_TIPOS_PRESTAMOS ADD (
...
ALTER TABLE SINDICATO_132.SD_TRANSFERENCIAS ADD (
...
ALTER TABLE SINDICATO_132.SD_TRANSFERENCIAS_HOJAS ADD (
...
ALTER TABLE SINDICATO_132.SD_USUARIOS ADD (
  CONSTRAINT SG_USUARIOS_PK
 PRIMARY KEY
 (ID_USUARIO));


ALTER TABLE SINDICATO_132.SD_VENTA_HOJAS_CONTROL ADD (
...
ALTER TABLE SINDICATO_132.SD_AMORTIZACIONES ADD (
...
ALTER TABLE SINDICATO_132.SD_CHOFERES ADD (
...
ALTER TABLE SINDICATO_132.SD_CIERRES_PARADA ADD (
...
ALTER TABLE SINDICATO_132.SD_DEPOSITO_FE ADD (
...
ALTER TABLE SINDICATO_132.SD_DESCUENTOS_SOCIO ADD (
...
ALTER TABLE SINDICATO_132.SD_DETALLE_CIERRE_GESTION ADD (
  CONSTRAINT SD_DETALLE_CIERRE_GESTION_PK
 PRIMARY KEY
 (ID_DETALLE)
    USING INDEX 
    TABLESPACE USERS
...
ALTER TABLE SINDICATO_132.SD_DETALLE_CIERRE_PARADA ADD (
...
ALTER TABLE SINDICATO_132.SD_DETALLE_PERIODO_SOCIO ADD (
...
ALTER TABLE SINDICATO_132.SD_DOCUMENTACIONES ADD (
...
ALTER TABLE SINDICATO_132.SD_EGRESOS ADD (
...
ALTER TABLE SINDICATO_132.SD_FAMILIARES ADD (
...
ALTER TABLE SINDICATO_132.SD_GARANTES ADD (
...
ALTER TABLE SINDICATO_132.SD_HOJAS_CONTROL ADD (
...
ALTER TABLE SINDICATO_132.SD_HOJAS_LINEA ADD (
...
ALTER TABLE SINDICATO_132.SD_INGRESOS_POR_SOCIOS ADD (
...
ALTER TABLE SINDICATO_132.SD_INGRESOS_SOCIO ADD (
...
ALTER TABLE SINDICATO_132.SD_KARDEX_FM ADD (
...
ALTER TABLE SINDICATO_132.SD_KARDEX_HOJAS ADD (
...
ALTER TABLE SINDICATO_132.SD_KARDEX_SOCIO ADD (
...
ALTER TABLE SINDICATO_132.SD_KARDEX_SOCIO_DEBE ADD (
...
ALTER TABLE SINDICATO_132.SD_KARDEX_SOCIO_MOVIL ADD (
...
ALTER TABLE SINDICATO_132.SD_OBLIGACIONES_SOCIO ADD (
...
ALTER TABLE SINDICATO_132.SD_OTRAS_OBLIGACIONES ADD (
...
ALTER TABLE SINDICATO_132.SD_PERMISOS ADD (
...
ALTER TABLE SINDICATO_132.SD_PRESTAMOS_POR_SOCIOS ADD (
...
ALTER TABLE SINDICATO_132.SD_REGULARIZACIONES ADD (
...
ALTER TABLE SINDICATO_132.SD_RETIRO_FE ADD (
...
ALTER TABLE SINDICATO_132.SD_RETIRO_SOCIO ADD (
...
ALTER TABLE SINDICATO_132.SD_RETIRO_SOCIO_MOVIL ADD (
...
ALTER TABLE SINDICATO_132.SD_TRANSF_HOJA_DET ADD (
...
ALTER TABLE SINDICATO_132.SD_VENTA_HOJAS ADD (
...
ALTER TABLE SINDICATO_132.SD_ANTECEDENTES ADD (
...
ALTER TABLE SINDICATO_132.SD_ANULACIONES ADD (
...
ALTER TABLE SINDICATO_132.SD_DETALLES_HOJAS_CONTROL ADD (
...
ALTER TABLE SINDICATO_132.SD_DETALLES_REGULARIZACIONES ADD (
...
ALTER TABLE SINDICATO_132.SD_KARDEX_OBLIGACION ADD (
...
ALTER TABLE SINDICATO_132.SD_PLAN_DE_PAGO ADD (
...
ALTER TABLE SINDICATO_132.SD_PRESTAMOS_MORA ADD (
...
ALTER TABLE SINDICATO_132.SD_PAGO_DE_PRESTAMOS ADD (
...
ALTER TABLE SINDICATO_132.SD_DESCUENTOS ADD (
 ...
 REFERENCES SINDICATO_132.SD_CIERRES (ID_CIERRE));

ALTER TABLE SINDICATO_132.SD_DESCUENTOS ADD (
  CONSTRAINT SD_DESCUENTOS_R02 
 FOREIGN KEY (ID_CAJA) 
 REFERENCES SINDICATO_132.SD_CAJAS (ID_CAJA));
...
ALTER TABLE SINDICATO_132.SD_DETALLE_CIERRES_CAJA ADD (
 ...
 FOREIGN KEY (ID_CIERRE) 
 REFERENCES SINDICATO_132.SD_CIERRES_CAJAS (ID_CIERRE));
...
ALTER TABLE SINDICATO_132.SD_LISTAS_ITEMS ADD (
 ...
 REFERENCES SINDICATO_132.SD_LISTAS (ID_LISTA));

ALTER TABLE SINDICATO_132.SD_LISTAS_ITEMS ADD (
  CONSTRAINT SG_LISTAS_ITEMS_R02 
 FOREIGN KEY (ID_PADRE) 
 REFERENCES SINDICATO_132.SD_LISTAS_ITEMS (ID_TABLA));


ALTER TABLE SINDICATO_132.SD_MOVILES ADD (
  CONSTRAINT SD_MOVILES_R01 
 FOREIGN KEY (ID_LINEA) 
 REFERENCES SINDICATO_132.SD_LINEAS (ID_LINEA));
...
ALTER TABLE SINDICATO_132.SD_PERFILES ADD (
 ...
 REFERENCES SINDICATO_132.SD_PARADAS (ID_PARADA));


ALTER TABLE SINDICATO_132.SD_PERFILES_OPCIONES ADD (
  CONSTRAINT SG_PERFILES_OPCIONES_R01 
 FOREIGN KEY (ID_PERFIL) 
 REFERENCES SINDICATO_132.SD_PERFILES (ID_PERFIL));

ALTER TABLE SINDICATO_132.SD_PERFILES_OPCIONES ADD (
  CONSTRAINT SG_PERFILES_OPCIONES_R02 
 FOREIGN KEY (ID_OPC) 
 REFERENCES SINDICATO_132.SD_MENU_OPCIONES (ID_OPC));


ALTER TABLE SINDICATO_132.SD_SOCIO_DESEMPENOS ADD (
  CONSTRAINT SD_SOCIO_DESEMPENOS_R01 
 FOREIGN KEY (ID_SOCIO) 
 REFERENCES SINDICATO_132.SD_SOCIOS (ID_SOCIO));
...
ALTER TABLE SINDICATO_132.SD_SOCIO_MOVILES ADD (
 ...
 REFERENCES SINDICATO_132.SD_MOVILES (ID_MOVIL));


ALTER TABLE SINDICATO_132.SD_SOCIO_MOVIL_AUTOS ADD (
  CONSTRAINT SD_SOCIO_MOVIL_AUTOS_R01 
 FOREIGN KEY (ID_SOCIO_MOVIL) 
 REFERENCES SINDICATO_132.SD_SOCIO_MOVILES (ID_SOCIO_MOVIL));

ALTER TABLE SINDICATO_132.SD_SOCIO_MOVIL_AUTOS ADD (
  CONSTRAINT SD_SOCIO_MOVIL_AUTOS_R02 
 FOREIGN KEY (ID_AUTO) 
 REFERENCES SINDICATO_132.SD_AUTOS (ID_AUTO));


ALTER TABLE SINDICATO_132.SD_SOC_MOV_OBLIG ADD (
  CONSTRAINT SD_SOC_MOV_OBLIG_R01 
 FOREIGN KEY (ID_OBLIGACION) 
 REFERENCES SINDICATO_132.SD_OBLIGACIONES_HOJA (ID_OBLIGACION));
...
ALTER TABLE SINDICATO_132.SD_DEPOSITO_FE ADD (
 ...
 REFERENCES SINDICATO_132.SD_CHOFERES (ID_CHOFER));


ALTER TABLE SINDICATO_132.SD_DESCUENTOS_SOCIO ADD (
  CONSTRAINT SD_DESCUENTOS_SOCIO_R01 
 FOREIGN KEY (ID_DESCUENTO) 
 REFERENCES SINDICATO_132.SD_DESCUENTOS (ID_DESCUENTO));
...
ALTER TABLE SINDICATO_132.SD_DETALLE_CIERRE_GESTION ADD (
  CONSTRAINT SD_DETALLE_CIERRE_GESTION_R01 
 FOREIGN KEY (ID_GESTION) 
 REFERENCES SINDICATO_132.SD_GESTION (ID_GESTION));


ALTER TABLE SINDICATO_132.SD_DETALLE_CIERRE_PARADA ADD (
  CONSTRAINT SD_DETALLE_CIERRE_PARADA_R01 
 FOREIGN KEY (ID_CIERRE) 
 REFERENCES SINDICATO_132.SD_CIERRES_PARADA (ID_CIERRE));
...
ALTER TABLE SINDICATO_132.SD_EGRESOS ADD (
 ...
 FOREIGN KEY (ID_TIPO) 
 REFERENCES SINDICATO_132.SD_TIPOS_EGRESOS (ID_TIPO));
...
ALTER TABLE SINDICATO_132.SD_INGRESOS_POR_SOCIOS ADD (
 ...
 REFERENCES SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO (ID_TIPO));
...
ALTER TABLE SINDICATO_132.SD_PRESTAMOS_POR_SOCIOS ADD (
 ...
 REFERENCES SINDICATO_132.SD_TIPOS_PRESTAMOS (ID_TIPO));
...
ALTER TABLE SINDICATO_132.SD_TRANSF_HOJA_DET ADD (
 ...
 REFERENCES SINDICATO_132.SD_TRANSFERENCIAS_HOJAS (ID_TRANSF));

ALTER TABLE SINDICATO_132.SD_TRANSF_HOJA_DET ADD (
  CONSTRAINT SD_TRANSF_HOJA_DET_R02 
 FOREIGN KEY (ID_HOJA) 
 REFERENCES SINDICATO_132.SD_HOJAS_CONTROL (ID_HOJA));
...
ALTER TABLE SINDICATO_132.SD_DETALLES_REGULARIZACIONES ADD (
 ...
 REFERENCES SINDICATO_132.SD_REGULARIZACIONES (ID_REGULACION));
...
ALTER TABLE SINDICATO_132.SD_KARDEX_OBLIGACION ADD (
 ...
 FOREIGN KEY (ID_OBLIGACION) 
 REFERENCES SINDICATO_132.SD_OBLIGACIONES_SOCIO (ID_OBLIGACION));


ALTER TABLE SINDICATO_132.SD_PLAN_DE_PAGO ADD (
  CONSTRAINT SD_PLAN_DE_PAGO_R01 
 FOREIGN KEY (ID_PRESTAMO) 
 REFERENCES SINDICATO_132.SD_PRESTAMOS_POR_SOCIOS (ID_PRESTAMO));
...
ALTER TABLE SINDICATO_132.SD_PRESTAMOS_MORA ADD (
  CONSTRAINT SD_PRESTAMOS_MORA_R02 
 FOREIGN KEY (ID_PLAN) 
 REFERENCES SINDICATO_132.SD_PLAN_DE_PAGO (ID_PLAN));
...
ALTER TABLE SINDICATO_132.SD_PAGO_DE_PRESTAMOS ADD (
  CONSTRAINT SD_PAGO_DE_PRESTAMOS_R04 
 FOREIGN KEY (ID_MORA) 
 REFERENCES SINDICATO_132.SD_PRESTAMOS_MORA (ID_MORA));

ALTER TABLE SINDICATO_132.SD_PAGO_DE_PRESTAMOS ADD (
  CONSTRAINT SD_PAGO_DE_PRESTAMOS_R05 
 FOREIGN KEY (ID_GESTION) 
 REFERENCES SINDICATO_132.SD_GESTION (ID_GESTION));
DROP SEQUENCE SINDICATO_132.DEMO_CUST_SEQ;

CREATE SEQUENCE SINDICATO_132.DEMO_CUST_SEQ
  START WITH 21
...
DROP SEQUENCE SINDICATO_132.DEMO_ORDER_ITEMS_SEQ;

CREATE SEQUENCE SINDICATO_132.DEMO_ORDER_ITEMS_SEQ
  START WITH 61
  MAXVALUE 9999999999999999999999999999
  MINVALUE 1
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.DEMO_ORD_SEQ;

CREATE SEQUENCE SINDICATO_132.DEMO_ORD_SEQ
  START WITH 11
  MAXVALUE 9999999999999999999999999999
  MINVALUE 1
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.DEMO_PROD_SEQ;

CREATE SEQUENCE SINDICATO_132.DEMO_PROD_SEQ
  START WITH 21
  MAXVALUE 9999999999999999999999999999
  MINVALUE 1
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.DEMO_USERS_SEQ;

CREATE SEQUENCE SINDICATO_132.DEMO_USERS_SEQ
  START WITH 21
  MAXVALUE 9999999999999999999999999999
  MINVALUE 1
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_AMORTIZACIONES;

CREATE SEQUENCE SINDICATO_132.Q_SD_AMORTIZACIONES
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_ANTECEDENTES;

CREATE SEQUENCE SINDICATO_132.Q_SD_ANTECEDENTES
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_ANULACIONES;

CREATE SEQUENCE SINDICATO_132.Q_SD_ANULACIONES
  START WITH 698
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_AUTOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_AUTOS
  START WITH 607
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_AUX_LOG_ERRORES;

CREATE SEQUENCE SINDICATO_132.Q_SD_AUX_LOG_ERRORES
  START WITH 563594
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_CAJAS;

CREATE SEQUENCE SINDICATO_132.Q_SD_CAJAS
  START WITH 28
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_CHOFERES;

CREATE SEQUENCE SINDICATO_132.Q_SD_CHOFERES
  START WITH 29
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_CIERRES;

CREATE SEQUENCE SINDICATO_132.Q_SD_CIERRES
  START WITH 92
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_CIERRES_CAJAS;

CREATE SEQUENCE SINDICATO_132.Q_SD_CIERRES_CAJAS
  START WITH 16
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_CIERRES_PARADA;

CREATE SEQUENCE SINDICATO_132.Q_SD_CIERRES_PARADA
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_DESCUENTOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_DESCUENTOS
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_DESCUENTOS_SOCIO;

CREATE SEQUENCE SINDICATO_132.Q_SD_DESCUENTOS_SOCIO
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_DETALLES_HOJAS_CONTROL;

CREATE SEQUENCE SINDICATO_132.Q_SD_DETALLES_HOJAS_CONTROL
  START WITH 901774
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_DETALLES_REGULARIZACIONES;

CREATE SEQUENCE SINDICATO_132.Q_SD_DETALLES_REGULARIZACIONES
  START WITH 29442
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_DETALLE_CIERRES_AHORRO;

CREATE SEQUENCE SINDICATO_132.Q_SD_DETALLE_CIERRES_AHORRO
  START WITH 18544
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_DETALLE_CIERRES_CAJA;

CREATE SEQUENCE SINDICATO_132.Q_SD_DETALLE_CIERRES_CAJA
  START WITH 130
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_DETALLE_CIERRE_GESTION;

CREATE SEQUENCE SINDICATO_132.Q_SD_DETALLE_CIERRE_GESTION
  START WITH 304
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_DETALLE_CIERRE_PARADA;

CREATE SEQUENCE SINDICATO_132.Q_SD_DETALLE_CIERRE_PARADA
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_DETALLE_HOJAS;

CREATE SEQUENCE SINDICATO_132.Q_SD_DETALLE_HOJAS
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_DETALLE_PERIODO_SOCIO;

CREATE SEQUENCE SINDICATO_132.Q_SD_DETALLE_PERIODO_SOCIO
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_DOCUMENTACIONES;

CREATE SEQUENCE SINDICATO_132.Q_SD_DOCUMENTACIONES
  START WITH 3
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_EGRESOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_EGRESOS
  START WITH 2324
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_FAMILIARES;

CREATE SEQUENCE SINDICATO_132.Q_SD_FAMILIARES
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_GARANTES;

CREATE SEQUENCE SINDICATO_132.Q_SD_GARANTES
  START WITH 29
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_GESTION;

CREATE SEQUENCE SINDICATO_132.Q_SD_GESTION
  START WITH 7
  MAXVALUE 9999999999999999999999999999
  MINVALUE 2
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_HIST_EDICION_DATOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_HIST_EDICION_DATOS
  START WITH 142
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_HOJAS_CONTROL;

CREATE SEQUENCE SINDICATO_132.Q_SD_HOJAS_CONTROL
  START WITH 621250
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_IMPRESIONES;

CREATE SEQUENCE SINDICATO_132.Q_SD_IMPRESIONES
  START WITH 917
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_INGRESOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_INGRESOS
  START WITH 17
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_INGRESOS_POR_SOCIOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_INGRESOS_POR_SOCIOS
  START WITH 5165
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_INGRESOS_SOCIO;

CREATE SEQUENCE SINDICATO_132.Q_SD_INGRESOS_SOCIO
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_JOBS_BACKUP;

CREATE SEQUENCE SINDICATO_132.Q_SD_JOBS_BACKUP
  START WITH 563173
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_KARDEX_EFECTIVO;

CREATE SEQUENCE SINDICATO_132.Q_SD_KARDEX_EFECTIVO
  START WITH 1379870
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_KARDEX_FM;

CREATE SEQUENCE SINDICATO_132.Q_SD_KARDEX_FM
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_KARDEX_HOJAS;

CREATE SEQUENCE SINDICATO_132.Q_SD_KARDEX_HOJAS
  START WITH 32017
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_KARDEX_OBLIGACION;

CREATE SEQUENCE SINDICATO_132.Q_SD_KARDEX_OBLIGACION
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_KARDEX_SOCIO;

CREATE SEQUENCE SINDICATO_132.Q_SD_KARDEX_SOCIO
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_KARDEX_SOCIO_DEBE;

CREATE SEQUENCE SINDICATO_132.Q_SD_KARDEX_SOCIO_DEBE
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_KARDEX_SOCIO_MOVIL;

CREATE SEQUENCE SINDICATO_132.Q_SD_KARDEX_SOCIO_MOVIL
  START WITH 21194
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_LISTAS;

CREATE SEQUENCE SINDICATO_132.Q_SD_LISTAS
  START WITH 21
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_LISTAS_ITEMS;

CREATE SEQUENCE SINDICATO_132.Q_SD_LISTAS_ITEMS
  START WITH 1041
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_MOVILES;

CREATE SEQUENCE SINDICATO_132.Q_SD_MOVILES
  START WITH 496
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_OBLIGACIONES_SOCIO;

CREATE SEQUENCE SINDICATO_132.Q_SD_OBLIGACIONES_SOCIO
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_OTRAS_OBLIGACIONES;

CREATE SEQUENCE SINDICATO_132.Q_SD_OTRAS_OBLIGACIONES
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_PAGO_DE_PRESTAMOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_PAGO_DE_PRESTAMOS
  START WITH 194
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_PERFILES;

CREATE SEQUENCE SINDICATO_132.Q_SD_PERFILES
  START WITH 5
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_PERFILES_OPCIONES;

CREATE SEQUENCE SINDICATO_132.Q_SD_PERFILES_OPCIONES
  START WITH 105
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_PERMISOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_PERMISOS
  START WITH 213
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_PLAN_DE_PAGO;

CREATE SEQUENCE SINDICATO_132.Q_SD_PLAN_DE_PAGO
  START WITH 864
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_PRESTAMOS_MORA;

CREATE SEQUENCE SINDICATO_132.Q_SD_PRESTAMOS_MORA
  START WITH 83
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_PRESTAMOS_POR_SOCIOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_PRESTAMOS_POR_SOCIOS
  START WITH 72
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_REGULARIZACIONES;

CREATE SEQUENCE SINDICATO_132.Q_SD_REGULARIZACIONES
  START WITH 7362
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_RETIRO_SOCIO;

CREATE SEQUENCE SINDICATO_132.Q_SD_RETIRO_SOCIO
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_RETIRO_SOCIO_MOVIL;

CREATE SEQUENCE SINDICATO_132.Q_SD_RETIRO_SOCIO_MOVIL
  START WITH 2635
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_SOCIOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_SOCIOS
  START WITH 788
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_SOCIO_DESEMPENOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_SOCIO_DESEMPENOS
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_SOCIO_MOVILES;

CREATE SEQUENCE SINDICATO_132.Q_SD_SOCIO_MOVILES
  START WITH 789
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_SOCIO_MOVIL_AUTOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_SOCIO_MOVIL_AUTOS
  START WITH 608
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_SOC_MOV_OBLIG;

CREATE SEQUENCE SINDICATO_132.Q_SD_SOC_MOV_OBLIG
  START WITH 1502
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_TIPOS_EGRESOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_TIPOS_EGRESOS
  START WITH 32
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_TIPOS_INGRESOS_SOCIO;

CREATE SEQUENCE SINDICATO_132.Q_SD_TIPOS_INGRESOS_SOCIO
  START WITH 110
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_TIPOS_PRESTAMOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_TIPOS_PRESTAMOS
  START WITH 10
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_TRANSFERENCIAS;

CREATE SEQUENCE SINDICATO_132.Q_SD_TRANSFERENCIAS
  START WITH 30
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_TRANSFERENCIAS_HOJAS;

CREATE SEQUENCE SINDICATO_132.Q_SD_TRANSFERENCIAS_HOJAS
  START WITH 23
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_TRANSF_HOJA_DET;

CREATE SEQUENCE SINDICATO_132.Q_SD_TRANSF_HOJA_DET
  START WITH 196
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_USUARIOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_USUARIOS
  START WITH 9
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_VENTA_HOJAS;

CREATE SEQUENCE SINDICATO_132.Q_SD_VENTA_HOJAS
  START WITH 271572
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
DROP SEQUENCE SINDICATO_132.Q_SD_VENTA_HOJAS_CONTROL;

CREATE SEQUENCE SINDICATO_132.Q_SD_VENTA_HOJAS_CONTROL
  START WITH 2
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
  NOCACHE
  NOORDER;
DROP PROCEDURE SINDICATO_132.P_AUX_CONSTRUCTOR_SP_GRABAR;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_AUX_CONSTRUCTOR_SP_GRABAR(p_tabla varchar2, p_parte number) 
 /*
...
DROP PROCEDURE SINDICATO_132.P_BACKUPTRAILER;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_BACKUPTRAILER(
 p_res OUT  VARCHAR2
)
...
BEGIN
  ...
  IF v_res='0' THEN
      FOR x IN (SELECT  *   FROM all_tables WHERE OWNER = 'SINDICATO_132' AND TABLE_NAME NOT IN   (select distinct table_name   from all_constraints WHERE OWNER = 'SINDICATO_132' and constraint_type = 'R') ) LOOP
      v_sql := 'DELETE FROM SINDICATO_132.'||x.TABLE_NAME||'';
      DBMS_OUTPUT.PUT_LINE(  v_sql );
     EXECUTE IMMEDIATE v_sql ;
     DBMS_OUTPUT.PUT_LINE(  v_sql );
      v_sql := 'INSERT INTO SINDICATO_132.'||x.TABLE_NAME||' (SELECT * FROM  '||x.TABLE_NAME||'@DBSINDICATO_132)';        
       --DBMS_OUTPUT.PUT_LINE(  v_sql );
      ...
      FOR x IN (SELECT  *   FROM all_tables WHERE OWNER = 'SINDICATO_132' AND TABLE_NAME  IN (select distinct table_name   from all_constraints WHERE OWNER = 'SINDICATO_132' and constraint_type = 'R' )ORDER BY  TABLE_NAME ASC ) LOOP
      v_sql := 'DELETE FROM SINDICATO_132.'||x.TABLE_NAME||'';
      DBMS_OUTPUT.PUT_LINE(  v_sql );
     EXECUTE IMMEDIATE v_sql ;
     DBMS_OUTPUT.PUT_LINE(  v_sql );
...
DROP PROCEDURE SINDICATO_132.P_BACKUP_SERVER;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_BACKUP_SERVER(
 p_res OUT  VARCHAR2
)
...
DROP PROCEDURE SINDICATO_132.P_BACKUP_SERVERTOLOCAL;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_BACKUP_SERVERTOLOCAL(
 p_res OUT  VARCHAR2
)
...
BEGIN
  ...
  IF v_res='0' THEN
     ...
     INSERT INTO SD_JOBS_BACKUP (ID_BACKUP , FECHA_REG) VALUES (Q_SD_JOBS_BACKUP.nextval , sysdate);
      ...
      FOR x IN (SELECT * FROM BACKUP_SINDICATO ORDER BY ORDEN DESC) LOOP
          --v_sql := 'DELETE FROM '||x.TABLA||'@DBSINDICATO_BACKUP';
          v_sql := 'DELETE FROM SINDICATO_132_012023.'||x.TABLA;
          EXECUTE IMMEDIATE v_sql ;
           --SELECT * FROM SD_AUTOS@DBSINDICATO_BACKUP
       END LOOP;
       
      FOR x IN (SELECT * FROM BACKUP_SINDICATO ORDER BY ORDEN ASC) LOOP
          v_sql := 'INSERT INTO SINDICATO_132_012023.'||x.TABLA||'  (SELECT * FROM '||x.TABLA ||')';
          EXECUTE IMMEDIATE v_sql ;
           --SELECT * FROM SD_AUTOS@DBSINDICATO_BACKUP
 --          INSERT INTO SD_AUTOS@DBSINDICATO_BACKUP (select * FROM SD_AUTOS)
       END LOOP;
...
DROP PROCEDURE SINDICATO_132.P_GRABAR_ERROR_BD;

CREATE OR REPLACE PROCEDURE SINDICATO_132.p_grabar_error_bd( 
 p_errC      SINDICATO_132.sd_aux_log_errores.cod_error%type,
 p_errD      SINDICATO_132.sd_aux_log_errores.desc_error%type,
 p_modulo    SINDICATO_132.sd_aux_log_errores.modulo%type,
 p_nombre_sp SINDICATO_132.sd_aux_log_errores.nombre_sp%TYPE,
 p_cad_sql   SINDICATO_132.sd_aux_log_errores.cad_sql%type,
...
BEGIN
  SELECT SINDICATO_132.q_sd_aux_log_errores.nextval INTO v_id_log FROM dual;
  
  INSERT INTO SINDICATO_132.sd_aux_log_errores(id_log, login_usr, fecha, modulo, nombre_sp, cod_error, desc_error, cad_sql) 
...
DROP PROCEDURE SINDICATO_132.P_REC_PARAMETROS;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_REC_PARAMETROS(
...
DROP PROCEDURE SINDICATO_132.P_SD_ACT_KARDEX_DEBE;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ACT_KARDEX_DEBE(
...
DROP PROCEDURE SINDICATO_132.P_SD_ACT_KARDEX_EFECTIVO;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ACT_KARDEX_EFECTIVO(
...
DROP PROCEDURE SINDICATO_132.P_SD_ACT_KARDEX_FM;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ACT_KARDEX_FM(
...
DROP PROCEDURE SINDICATO_132.P_SD_ACT_KARDEX_HOJA;
  ...
  WHILE v_fecha < v_fecha_hasta LOOP
   ...
   ELSE
     ...
     --   SELECT TO_CHAR(sysdate , 'MM-YYYY') FROM DUAL 
       ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '03-2020' THEN
             v_cantidad_hojas_oblig := 15;
       ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '04-2020' THEN
             v_cantidad_hojas_oblig := 0;
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '05-2020' THEN
             v_cantidad_hojas_oblig := 0;  
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '06-2020' THEN
             v_cantidad_hojas_oblig := 8;   
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '07-2020' THEN
             v_cantidad_hojas_oblig := 0;        
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '08-2020' THEN
             v_cantidad_hojas_oblig := 0;        
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '09-2020' THEN
             v_cantidad_hojas_oblig := 0; 
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '09-2020' THEN
             v_cantidad_hojas_oblig := 0; 
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '10-2020' THEN
             v_cantidad_hojas_oblig := 0; 
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '11-2020' THEN
             v_cantidad_hojas_oblig := 0;
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '12-2020' THEN
             v_cantidad_hojas_oblig := 0;
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '01-2021' THEN
             v_cantidad_hojas_oblig := 10;    
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '02-2021' THEN
             v_cantidad_hojas_oblig := 10;     
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '03-2021' THEN
             v_cantidad_hojas_oblig := 10;     
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '04-2021' THEN
             v_cantidad_hojas_oblig := 11;     
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '05-2021' THEN
             v_cantidad_hojas_oblig := 11;     
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '06-2021' THEN
             v_cantidad_hojas_oblig := 11;
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '07-2021' THEN
             v_cantidad_hojas_oblig := 11;    
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '08-2021' THEN
             v_cantidad_hojas_oblig := 11;         
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '09-2021' THEN
             v_cantidad_hojas_oblig := 12;   
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '10-2021' THEN
             v_cantidad_hojas_oblig := 12;  
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '11-2021' THEN
             v_cantidad_hojas_oblig := 12;  
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '12-2021' THEN
             v_cantidad_hojas_oblig := 12;  
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '01-2022' THEN
             v_cantidad_hojas_oblig := 12;  
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '02-2022' THEN
             v_cantidad_hojas_oblig := 12;  
       ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '03-2022' THEN
             v_cantidad_hojas_oblig := 14;  
       ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '04-2022' THEN
             v_cantidad_hojas_oblig := 14;  
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '05-2022' THEN
             v_cantidad_hojas_oblig := 15;      
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '06-2022' THEN
             v_cantidad_hojas_oblig := 16;     
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '07-2022' THEN
             v_cantidad_hojas_oblig := 16;     
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '08-2022' THEN
             v_cantidad_hojas_oblig := 17;
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '09-2022' THEN
             v_cantidad_hojas_oblig := 18;     
        ELSIF  TO_CHAR(v_fecha , 'MM-YYYY') = '10-2022' THEN
             v_cantidad_hojas_oblig := 19;     
        ELSE
        P_REC_PARAMETROS('CANT_HOJA',1,v_cantidad_hojas_oblig);
        END IF;
      --   P_REC_PARAMETROS('CANT_HOJA',1,v_cantidad_hojas_oblig);
...
DROP PROCEDURE SINDICATO_132.P_SD_ACT_KARDEX_SOCIO;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ACT_KARDEX_SOCIO(
...
DROP PROCEDURE SINDICATO_132.P_SD_ACT_KARDEX_SOCIO_MOVIL;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ACT_KARDEX_SOCIO_MOVIL(
...
DROP PROCEDURE SINDICATO_132.P_SD_ACT_OBLIGACIONES;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ACT_OBLIGACIONES(
p_id_socio SINDICATO_132.SD_OBLIGACIONES_SOCIO.ID_SOCIO%type,
p_id_obligacion SINDICATO_132.SD_OBLIGACIONES_SOCIO.ID_OBLIGACION%type,
p_fecha SINDICATO_132.SD_KARDEX_OBLIGACION.FECHA %type,
p_motivo SINDICATO_132.SD_KARDEX_OBLIGACION.MOTIVO%type,
p_importe_nuevo SINDICATO_132.SD_KARDEX_OBLIGACION.IMPORTE_NUEVO%type,
p_usr VARCHAR2,
p_res OUT VARCHAR2
)
IS
...
DROP PROCEDURE SINDICATO_132.P_SD_ACT_PAGOS_SOCIOS;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ACT_PAGOS_SOCIOS(
...
DROP PROCEDURE SINDICATO_132.P_SD_ACT_PLAN_PAGOS;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ACT_PLAN_PAGOS(
...
IS
 ...
 v_saldo_interes number := 0;
 v_saldo_mora number := 0;
         ...
         FOR x IN (SELECT * FROM  SD_PLAN_DE_PAGO     WHERE ID_PRESTAMO   = p_id_prestamo    order by NRO_SEMANA   ASC ) LOOP 
                    ...
                    SELECT IMPORTE_A_PAGAR , INTERES_A_PAGAR INTO v_pago , v_interes FROM SD_PLAN_DE_PAGO WHERE ID_PLAN  = x.ID_PLAN ;
                     IF  v_total >= (v_pago + v_interes) THEN
                       v_saldo_capital := v_saldo_capital + v_pago;
                       v_saldo_interes := v_saldo_interes + v_interes;
                        UPDATE SD_PLAN_DE_PAGO SET ESTADO = 'CANCELADO' WHERE  ID_PLAN  = x.ID_PLAN ;
                        v_total := v_total - (v_pago + v_interes);
                     ELSE
                       v_saldo_capital := v_saldo_capital + (v_total - round((v_total * 7/100),2));
                       v_saldo_interes := v_saldo_interes + round( (v_total * 7/100),2);
                        v_total :=0;
                        EXIT; 
                     END IF;   
         END LOOP;
...
--         IF v_total > 0 THEN
--             FOR y IN ( SELECT * FROM SD_PRESTAMOS_MORA WHERE ID_PRESTAMO =  p_id_prestamo AND ESTADO != 'ANULADO' order by ID_MORA ASC) LOOP
--                 SELECT IMPORTE_MORA  INTO v_mora  FROM SD_PRESTAMOS_MORA WHERE ID_MORA  = y.ID_MORA ;
--                   IF  v_total >=v_mora THEN
--                            v_saldo_mora := v_total - v_mora;                     
--                            UPDATE SD_PRESTAMOS_MORA SET ESTADO = 'CANCELADO' , SALDO_PLAN = v_saldo_mora WHERE  ID_MORA  = y.ID_MORA ;
--                            v_total := v_total - (v_mora);
--                         ELSE
--                            v_saldo_mora :=   v_mora  - v_total;    
--                            UPDATE SD_PRESTAMOS_MORA SET  ESTADO = 'NUEVO' , SALDO_PLAN = v_saldo_mora WHERE  ID_MORA  = y.ID_MORA ;
--                            v_total :=0;
--                            EXIT; 
--                     END IF; 
--             END LOOP;
--         ELSE
--             UPDATE SD_PRESTAMOS_MORA  SET ESTADO = 'NUEVO' ,SALDO_PLAN =  IMPORTE_MORA WHERE ID_PRESTAMO = p_id_prestamo ;
--         
--         END IF;
         
         
         UPDATE SD_PRESTAMOS_POR_SOCIOS SET SALDO_CAPITAL = v_saldo_capital , SALDO_INTERES = v_saldo_interes WHERE ID_PRESTAMO = p_id_prestamo ;
    p_res := v_res;
    COMMIT;
EXCEPTION
WHEN OTHERS THEN
...
DROP PROCEDURE SINDICATO_132.P_SD_ALTA_AUTOS;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ALTA_AUTOS(
p_id_auto SINDICATO_132.SD_AUTOS.ID_AUTO%type,
p_tipo SINDICATO_132.SD_AUTOS.TIPO%type,
p_color SINDICATO_132.SD_AUTOS.COLOR%type,
p_marca SINDICATO_132.SD_AUTOS.MARCA%type,
p_modelo SINDICATO_132.SD_AUTOS.MODELO%type,
p_placa SINDICATO_132.SD_AUTOS.PLACA%type,
p_motor SINDICATO_132.SD_AUTOS.MOTOR%type,
p_chasis SINDICATO_132.SD_AUTOS.CHASIS%type,
p_descripcion SINDICATO_132.SD_AUTOS.DESCRIPCION%type,
p_fecha_alta SINDICATO_132.SD_AUTOS.FECHA_ALTA%type,
p_fecha_baja SINDICATO_132.SD_AUTOS.FECHA_BAJA%type,
p_id_usr VARCHAR2,
p_res OUT VARCHAR2
)
IS
v_id_auto SINDICATO_132.SD_AUTOS.ID_AUTO%type;
v_cnt NUMBER:=0;
v_res VARCHAR2(100):='0';
v_errC SD_AUX_LOG_ERRORES.cod_error%type;
v_errD SD_AUX_LOG_ERRORES.desc_error%type;
...
IF v_res='0' THEN
    if p_id_auto = 0 THEN
       ...
       IF v_res = '0' THEN
            ...
            INSERT INTO SINDICATO_132.SD_AUTOS (id_auto  ,tipo ,color ,marca ,modelo ,placa ,motor ,chasis ,descripcion ,fecha_alta ,fecha_baja  ,fecha_reg ,login_usr )
...
DROP PROCEDURE SINDICATO_132.P_SD_ALTA_LISTA;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ALTA_LISTA(
...
DROP PROCEDURE SINDICATO_132.P_SD_ALTA_SD_CHOFERES;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ALTA_SD_CHOFERES(
p_id_chofer SINDICATO_132.SD_CHOFERES.ID_CHOFER%type,
p_nro_chofer SINDICATO_132.SD_CHOFERES.NRO_CHOFER%type,
p_nombre SINDICATO_132.SD_CHOFERES.NOMBRE%type,
p_apellido_paterno SINDICATO_132.SD_CHOFERES.APELLIDO_PATERNO%type,
p_apellido_materno SINDICATO_132.SD_CHOFERES.APELLIDO_MATERNO%type,
p_nro_licencia SINDICATO_132.SD_CHOFERES.NRO_LICENCIA%type,
p_categoria_lic SINDICATO_132.SD_CHOFERES.CATEGORIA_LIC%type,
p_ci SINDICATO_132.SD_CHOFERES.CI%type,
p_expedido SINDICATO_132.SD_CHOFERES.EXPEDIDO%type,
p_fecha_nac SINDICATO_132.SD_CHOFERES.FECHA_NAC%type,
p_fecha_ingreso SINDICATO_132.SD_CHOFERES.FECHA_INGRESO%type,
p_domicilio SINDICATO_132.SD_CHOFERES.DOMICILIO%type,
p_observacion SINDICATO_132.SD_CHOFERES.OBSERVACION%type,
p_estado_civil SINDICATO_132.SD_CHOFERES.ESTADO_CIVIL%type,
p_telefono SINDICATO_132.SD_CHOFERES.TELEFONO%type,
p_celular SINDICATO_132.SD_CHOFERES.CELULAR%type,
p_id_socio SINDICATO_132.SD_CHOFERES.ID_SOCIO%type,
p_id_usr NUMBER,
p_res OUT VARCHAR2
)
IS
v_id_chofer SINDICATO_132.SD_CHOFERES.ID_CHOFER%type;
v_id_socio SINDICATO_132.SD_CHOFERES.ID_SOCIO%type;
v_cnt NUMBER:=0;
v_res VARCHAR2(100):='0';
v_errC SD_AUX_LOG_ERRORES.cod_error%type;
v_errD SD_AUX_LOG_ERRORES.desc_error%type;
...
IF p_id_chofer =  0 THEN
    ...
    IF v_res='0' THEN
        ...
        INSERT INTO SINDICATO_132.SD_CHOFERES (id_chofer ,nro_chofer ,nombre ,apellido_paterno 
        ...
        VALUES( v_id_chofer,p_nro_chofer ,p_nombre ,p_apellido_paterno ,p_apellido_materno
         ...
         INSERT INTO SINDICATO_132.SD_GARANTES(ID_GARANTE ,ID_CHOFER, ID_SOCIO, OBSERVACION ,FECHA_INI, FECHA_REG ,ESTADO ,ID_USR  )
...
DROP PROCEDURE SINDICATO_132.P_SD_ALTA_SD_FAMILIARES;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ALTA_SD_FAMILIARES(
p_id_familiar SINDICATO_132.SD_FAMILIARES.ID_FAMILIAR%type,
p_id_socio SINDICATO_132.SD_FAMILIARES.ID_SOCIO%type,
p_id_chofer SINDICATO_132.SD_FAMILIARES.ID_CHOFER%type,
p_nombre SINDICATO_132.SD_FAMILIARES.NOMBRE%type,
p_apellido_paterno SINDICATO_132.SD_FAMILIARES.APELLIDO_PATERNO%type,
p_apellido_materno SINDICATO_132.SD_FAMILIARES.APELLIDO_MATERNO%type,
p_ci SINDICATO_132.SD_FAMILIARES.CI%type,
p_expedido SINDICATO_132.SD_FAMILIARES.EXPEDIDO%type,
p_fecha_nac SINDICATO_132.SD_FAMILIARES.FECHA_NAC%type,
p_parentesco SINDICATO_132.SD_FAMILIARES.PARENTESCO%type,
p_observacion SINDICATO_132.SD_FAMILIARES.OBSERVACION%type,
p_direccion SINDICATO_132.SD_FAMILIARES.DIRECCION%type,
p_telefono SINDICATO_132.SD_FAMILIARES.TELEFONO%type,
p_id_usr NUMBER,
p_res OUT VARCHAR2
)
IS
v_id_familiar SINDICATO_132.SD_FAMILIARES.ID_FAMILIAR%type;
v_cnt NUMBER:=0;
v_nro  NUMBER := 0;
v_res VARCHAR2(100):='0';
v_errC SD_AUX_LOG_ERRORES.cod_error%type;
...
IF v_res='0' THEN
    IF p_id_familiar = 0 THEN
        ...
        INSERT INTO SINDICATO_132.SD_FAMILIARES (id_familiar ,id_socio ,id_chofer ,nombre ,apellido_paterno ,apellido_materno ,ci ,expedido ,fecha_nac ,parentesco ,observacion ,fecha_reg ,id_usr, direccion, telefono )
...
DROP PROCEDURE SINDICATO_132.P_SD_ALTA_SD_SOCIOS;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ALTA_SD_SOCIOS(
p_id_socio SINDICATO_132.SD_SOCIOS.ID_SOCIO%type,
p_nombre SINDICATO_132.SD_SOCIOS.NOMBRE%type,
p_apellido_paterno SINDICATO_132.SD_SOCIOS.APELLIDO_PATERNO%type,
p_apellido_materno SINDICATO_132.SD_SOCIOS.APELLIDO_MATERNO%type,
p_nro_licencia SINDICATO_132.SD_SOCIOS.NRO_LICENCIA%type,
p_categoria_lic SINDICATO_132.SD_SOCIOS.CATEGORIA_LIC%type,
p_ci SINDICATO_132.SD_SOCIOS.CI%type,
p_expedido SINDICATO_132.SD_SOCIOS.EXPEDIDO%type,
p_fecha_nac SINDICATO_132.SD_SOCIOS.FECHA_NAC%type,
p_fecha_ingreso SINDICATO_132.SD_SOCIOS.FECHA_INGRESO%type,
p_domicilio SINDICATO_132.SD_SOCIOS.DOMICILIO%type,
p_observacion SINDICATO_132.SD_SOCIOS.OBSERVACION%type,
p_telefono SINDICATO_132.SD_SOCIOS.TELEFONO%type,
p_celular SINDICATO_132.SD_SOCIOS.CELULAR%type,
p_estado_civil SINDICATO_132.SD_SOCIOS.ESTADO_CIVIL%type,
p_id_usr NUMBER,
p_res OUT VARCHAR2
)
IS
v_id_socio SINDICATO_132.SD_SOCIOS.ID_SOCIO%type;
v_nro SINDICATO_132.SD_SOCIOS.NRO_SOCIO%type;
v_cnt NUMBER:=0;
v_res VARCHAR2(100):='0';
v_errC SD_AUX_LOG_ERRORES .cod_error%type;
v_errD SD_AUX_LOG_ERRORES.desc_error%type;
    ...
    IF v_res='0' THEN
            ...
            IF v_res='0' THEN
               v_id_socio := Q_SD_SOCIOS.nextval;
                ...
                INSERT INTO SINDICATO_132.SD_SOCIOS (id_socio  , NRO_SOCIO , nombre ,apellido_paterno ,apellido_materno ,nro_licencia ,categoria_lic ,ci ,expedido ,fecha_nac ,fecha_ingreso ,fecha_baja ,domicilio ,observacion ,estado_civil ,fecha_reg ,id_usr ,estado ,telefono , celular)
...
DROP PROCEDURE SINDICATO_132.P_SD_ANULAR_HOJA;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ANULAR_HOJA(
p_id_hoja  SINDICATO_132.SD_HOJAS_CONTROL.ID_HOJA%type,
...
DROP PROCEDURE SINDICATO_132.P_SD_ANULAR_PERMISOS;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ANULAR_PERMISOS(
...
DROP PROCEDURE SINDICATO_132.P_SD_ANULAR_REGULACION;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ANULAR_REGULACION(
p_id_regulacion  SINDICATO_132.SD_REGULARIZACIONES.ID_REGULACION %type,
...
DROP PROCEDURE SINDICATO_132.P_SD_BAJA_SOCIO_MOVILES;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_BAJA_SOCIO_MOVILES(
...
DROP PROCEDURE SINDICATO_132.P_SD_CAMBIO_GARANTE;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_CAMBIO_GARANTE(
p_id_chofer SINDICATO_132.SD_GARANTES .ID_CHOFER%type,
p_fecha_ini SINDICATO_132.SD_GARANTES.FECHA_INI %type,
p_observacion SINDICATO_132.SD_GARANTES.OBSERVACION%type,
p_id_socio SINDICATO_132.SD_GARANTES.ID_SOCIO%type,
p_usr VARCHAR2,
p_res OUT VARCHAR2
)
IS
...
IF v_res =  '0' THEN
        ...
        IF v_res =  '0' THEN
           ...
           commit;
            ...
            INSERT INTO SINDICATO_132.SD_GARANTES  (ID_GARANTE, ID_CHOFER ,ID_SOCIO ,OBSERVACION ,FECHA_INI,  FECHA_REG ,ESTADO, LOGIN  )
...
DROP PROCEDURE SINDICATO_132.P_SD_CREAR_OBLIGACIONES;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_CREAR_OBLIGACIONES(
p_id_socio SINDICATO_132.SD_OBLIGACIONES_SOCIO.ID_SOCIO%type,
p_fecha SINDICATO_132.SD_KARDEX_OBLIGACION.FECHA %type,
p_motivo SINDICATO_132.SD_KARDEX_OBLIGACION.MOTIVO%type,
p_usr VARCHAR2,
...
DROP PROCEDURE SINDICATO_132.P_SD_ELIMINAR_CAJA;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ELIMINAR_CAJA(
...
DROP PROCEDURE SINDICATO_132.P_SD_ELIMINAR_MORA;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ELIMINAR_MORA(
...
BEGIN
  ...
  IF v_res='0' THEN
    -- Verificamos que la LISTA no exista 
    SELECT COUNT(*) INTO v_cnt FROM SD_PRESTAMOS_MORA   WHERE ID_MORA   = p_id_mora  AND ESTADO = 'NUEVO';
    IF v_cnt = 0 THEN
      v_res := 'No existe la Mora o esta en estado INADECUADO.';
    END IF;
  END IF;
  IF v_res='0' THEN
      -- Creamos la LISTA
     -- DELETE FROM SD_PRESTAMOS_MORA  WHERE ID_MORA  = p_id_mora ;
        UPDATE SD_PRESTAMOS_MORA SET ESTADO = 'ANULADO' WHERE ID_MORA  = p_id_mora ;
        UPDATE SD_PLAN_DE_PAGO set mora_a_pagar = 0 where ID_PLAN = (select id_plan from SD_PRESTAMOS_MORA WHERE ID_MORA = p_id_mora);
      COMMIT;
...
DROP PROCEDURE SINDICATO_132.P_SD_ELIMINAR_PERFIL_OPCION;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ELIMINAR_PERFIL_OPCION(
...
DROP PROCEDURE SINDICATO_132.P_SD_ELIMINAR_SOCIO;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ELIMINAR_SOCIO(
...
DROP PROCEDURE SINDICATO_132.P_SD_GRABAR_HIST_EDICION_DATOS;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_GRABAR_HIST_EDICION_DATOS(
...
DROP PROCEDURE SINDICATO_132.P_SD_GRABAR_IMPRESION;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_GRABAR_IMPRESION(
...
DROP PROCEDURE SINDICATO_132.P_SD_GRABAR_LISTAS_ITEMS;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_GRABAR_LISTAS_ITEMS(
...
DROP PROCEDURE SINDICATO_132.P_SD_GRABAR_PERMISOS;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_GRABAR_PERMISOS(
...
DROP PROCEDURE SINDICATO_132.P_SD_GRABAR_SOCIO_MOVILES;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_GRABAR_SOCIO_MOVILES(
 p_id_socio_movil  IN SD_SOCIO_MOVILES.ID_SOCIO_MOVIL%TYPE,
  ...
  END IF;
   IF p_id_socio_movil = 0 THEN
        ...
        v_id := Q_SD_SOCIO_MOVILES.nextval;
         INSERT INTO SINDICATO_132.SD_SOCIO_MOVILES (id_socio_movil ,id_socio ,id_movil ,descripcion ,tipo_movil ,fecha_alta ,fecha_baja ,observacion ,fecha_reg ,id_usr ,estado )
...
DROP PROCEDURE SINDICATO_132.P_SD_GUARDAR_CAJAS;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_GUARDAR_CAJAS(
...
DROP PROCEDURE SINDICATO_132.P_SD_GUARDAR_FE;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_GUARDAR_FE(
...
DROP PROCEDURE SINDICATO_132.P_SD_GUARDAR_FONDO_EMER;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_GUARDAR_FONDO_EMER(
p_id_chofe SD_KARDEX_FM.ID_CHOFER%type,
p_id_kardex SD_KARDEX_FM.ID_KARDEX%type,
p_nro_cmp SD_KARDEX_FM.NRO_CMP%type,
p_operacion SD_KARDEX_FM.OPERACION%type,
...
DROP PROCEDURE SINDICATO_132.P_SD_GUARDAR_HOJA;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_GUARDAR_HOJA(
p_ID_SOCIO_MOVIL  SINDICATO_132.SD_HOJAS_CONTROL.ID_SOCIO_MOVIL%type,
p_id_parada SINDICATO_132.SD_HOJAS_CONTROL.Id_PARADA%type,
p_id_chofer SINDICATO_132.SD_HOJAS_CONTROL.ID_CHOFER%type,
p_fecha_compra SINDICATO_132.SD_HOJAS_CONTROL.FECHA_COMPRA %type,
p_cantidad number,
p_usr VARCHAR2,
p_res OUT VARCHAR2
)
...
DROP PROCEDURE SINDICATO_132.P_SD_GUARDAR_MORA;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_GUARDAR_MORA(
p_ID_MORA  SINDICATO_132.SD_PRESTAMOS_MORA .ID_MORA%type,
p_ID_PLAN  SINDICATO_132.SD_PRESTAMOS_MORA .ID_PLAN%type,
p_ID_PRESTAMO SINDICATO_132.SD_PRESTAMOS_MORA .ID_PRESTAMO %type,
p_importe_mora SINDICATO_132.SD_PRESTAMOS_MORA.IMPORTE_MORA %type,
p_fecha SINDICATO_132.SD_PRESTAMOS_MORA.FECHA%type,
p_observacion SINDICATO_132.SD_PRESTAMOS_MORA.OBSERVACION%type,
p_usr VARCHAR2,
p_res OUT VARCHAR2
)
IS
...
v_nro_movil  NUMBER := 0;
BEGIN
IF p_ID_MORA IS NULL OR p_ID_PRESTAMO IS NULL OR p_id_plan  IS NULL OR p_fecha IS NULL  OR p_importe_mora IS NULL
THEN
    v_res := 'Faltan parametros.';
END IF;
   
   SELECT COUNT(1) INTO v_cnt FROM SD_PRESTAMOS_MORA WHERE ID_PLAN = p_ID_PLAN AND estado <> 'ANULADO';
        IF v_cnt > 0 THEN
            v_res := 'La Semana ya cuenta con una Mora , solo se permite un registro de mora por un NRO de Semana';
        END IF;
IF v_res='0' THEN
--vamos a crear nuestra secuencia
   if p_ID_MORA = 0 THEN
        ...
        INSERT INTO SD_PRESTAMOS_MORA  (ID_MORA  ,ID_PLAN ,ID_PRESTAMO  ,FECHA  ,IMPORTE_MORA  ,OBSERVACION   ,FECHA_REG ,LOGIN_USR , ESTADO    ) 
         VALUES  (v_id , p_ID_PLAN , p_ID_PRESTAMO ,p_fecha, p_importe_mora,p_observacion  , sysdate , p_usr , 'NUEVO');
        
    ELSE
       
        UPDATE SD_PRESTAMOS_MORA SET IMPORTE_MORA  = p_importe_mora ,OBSERVACION  =p_observacion , FECHA  = p_fecha 
        WHERE ID_MORA   =  p_ID_MORA; 
         v_id := p_ID_MORA;
      
    END IF;
    UPDATE SD_PLAN_DE_PAGO SET MORA_A_PAGAR = p_importe_mora WHERE ID_PLAN = p_ID_PLAN;
END IF;
    if v_res = '0' THEN
        v_res := v_id;
     COMMIT;
...
DROP PROCEDURE SINDICATO_132.P_SD_GUARDAR_PERFIL;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_GUARDAR_PERFIL(
...
DROP PROCEDURE SINDICATO_132.P_SD_GUARDAR_REGULACION;
...
DROP PROCEDURE SINDICATO_132.P_SD_GUARDAR_TIPO_EGRESO;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_GUARDAR_TIPO_EGRESO(
p_id_tipo SINDICATO_132.SD_TIPOS_EGRESOS .ID_TIPO%type, 
p_id_caja SINDICATO_132.SD_TIPOS_EGRESOS.ID_CAJA%type,
p_nombre SINDICATO_132.SD_TIPOS_EGRESOS.NOMBRE%type,
p_observacion SINDICATO_132.SD_TIPOS_EGRESOS.OBSERVACION%type,
p_moneda SINDICATO_132.SD_TIPOS_EGRESOS.MONEDA%type,
p_importe SINDICATO_132.SD_TIPOS_EGRESOS.IMPORTE%type,
p_usr VARCHAR2,
p_res OUT VARCHAR2
)
IS
...
IF p_id_tipo =  0 THEN
    ...
    IF v_res='0' THEN
        ...
        INSERT INTO SINDICATO_132.SD_TIPOS_EGRESOS   (ID_TIPO, ID_CAJA ,NOMBRE, OBSERVACION ,ESTADO, MONEDA ,IMPORTE, FECHA_REG, LOGIN_USR   )
...
DROP PROCEDURE SINDICATO_132.P_SD_GUARDAR_TIPO_INGRESO;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_GUARDAR_TIPO_INGRESO(
p_id_tipo SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO.ID_TIPO%type, 
p_id_caja SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO.ID_CAJA%type,
p_nombre SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO.NOMBRE%type,
p_observacion SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO.OBSERVACION%type,
p_moneda SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO.MONEDA%type,
p_importe SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO.IMPORTE%type,
p_categoria SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO.CATEGORIA%type,
p_usr VARCHAR2,
p_res OUT VARCHAR2
)
IS
...
IF p_id_tipo =  0 THEN
    ...
    IF v_res='0' THEN
        ...
        INSERT INTO SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO  (ID_TIPO, ID_CAJA ,NOMBRE, OBSERVACION ,ESTADO, MONEDA ,IMPORTE, FECHA_REG, LOGIN_USR ,CATEGORIA  )
...
DROP PROCEDURE SINDICATO_132.P_SD_GUARDAR_TIPO_PRESTAMO;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_GUARDAR_TIPO_PRESTAMO(
p_id_tipo SINDICATO_132.SD_TIPOS_PRESTAMOS.ID_TIPO%type, 
p_id_caja SINDICATO_132.SD_TIPOS_PRESTAMOS.ID_CAJA%type,
p_nombre SINDICATO_132.SD_TIPOS_PRESTAMOS.NOMBRE%type,
p_observacion SINDICATO_132.SD_TIPOS_PRESTAMOS.OBSERVACION%type,
p_moneda SINDICATO_132.SD_TIPOS_PRESTAMOS.MONEDA%type,
p_importe_maximo SINDICATO_132.SD_TIPOS_PRESTAMOS.IMPORTE_MAXIMO%type,
p_importe_minimo SINDICATO_132.SD_TIPOS_PRESTAMOS.IMPORTE_MINIMO%type,
p_interes SINDICATO_132.SD_TIPOS_PRESTAMOS.INTERES%type,
p_multa_por_mora SINDICATO_132.SD_TIPOS_PRESTAMOS.MULTA_POR_MORA%type,
p_semanas SINDICATO_132.SD_TIPOS_PRESTAMOS.SEMANAS%type,
p_categoria SINDICATO_132.SD_TIPOS_PRESTAMOS.CATEGORIA%type,
p_tipo_interes SINDICATO_132.SD_TIPOS_PRESTAMOS.TIPO_INTERES%type,
p_interes_fijo SINDICATO_132.SD_TIPOS_PRESTAMOS.INTERES_FIJO%type,
p_dias_espera_mora SINDICATO_132.SD_TIPOS_PRESTAMOS.DIAS_ESPERA_MORA%type,
p_usr VARCHAR2,
p_res OUT VARCHAR2
)
IS
...
IF p_id_tipo =  0 THEN
    ...
    IF v_res='0' THEN
        ...
        INSERT INTO SINDICATO_132.SD_TIPOS_PRESTAMOS   (ID_TIPO, ID_CAJA ,NOMBRE, OBSERVACION ,ESTADO, MONEDA ,IMPORTE_MAXIMO, IMPORTE_MINIMO ,INTERES ,MULTA_POR_MORA ,SEMANAS  , FECHA_REG, LOGIN_USR ,CATEGORIA, INTERES_FIJO ,TIPO_INTERES , DIAS_ESPERA_MORA  )
        VALUES( v_id, p_id_caja , p_nombre ,p_observacion ,'ACTIVO', p_moneda, p_importe_maximo ,p_importe_minimo , p_interes,p_multa_por_mora , p_semanas, sysdate , p_usr , p_categoria,p_interes_fijo , p_tipo_interes  , p_dias_espera_mora );
         v_res := v_id;
    END IF;
ELSE
       IF v_res='0' THEN
         UPDATE SD_TIPOS_PRESTAMOS SET
         ID_CAJA =  p_id_caja ,  NOMBRE = p_nombre ,OBSERVACION = p_observacion ,  MONEDA  = p_moneda , IMPORTE_MAXIMO  = p_importe_maximo , 
         IMPORTE_MINIMO = p_importe_minimo ,INTERES = p_interes , MULTA_POR_MORA = p_multa_por_mora , SEMANAS = p_semanas  ,  
         LOGIN_USR  = p_usr  , CATEGORIA = p_categoria , INTERES_FIJO= p_interes_fijo , TIPO_INTERES = p_tipo_interes  , DIAS_ESPERA_MORA = p_dias_espera_mora
          WHERE ID_TIPO  = p_id_tipo;
...
DROP PROCEDURE SINDICATO_132.P_SD_INGRESOS_POR_SOCIO;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_INGRESOS_POR_SOCIO(
p_id_ingreso SINDICATO_132.SD_INGRESOS_POR_SOCIOS.ID_INGRESO%type, 
p_id_socio_movil SINDICATO_132.SD_INGRESOS_POR_SOCIOS.ID_SOCIO_MOVIL%type, 
p_id_tipo SINDICATO_132.SD_INGRESOS_POR_SOCIOS.ID_TIPO_INGRESO %type, 
p_fecha SINDICATO_132.SD_INGRESOS_POR_SOCIOS.FECHA%type,
p_importe SINDICATO_132.SD_INGRESOS_POR_SOCIOS.IMPORTE%type,
p_observacion SINDICATO_132.SD_INGRESOS_POR_SOCIOS.OBSERVACION%type,
p_usr VARCHAR2,
p_res OUT VARCHAR2
)
IS
...
END IF;
    ...
    IF v_res='0' THEN
        ...
        INSERT INTO SINDICATO_132.SD_INGRESOS_POR_SOCIOS  (ID_INGRESO ,ID_SOCIO_MOVIL, ID_TIPO_INGRESO ,ID_CAJA ,FECHA ,IMPORTE, MONEDA ,OBSERVACION ,ESTADO ,FECHA_REG ,LOGIN_USR )
...
DROP PROCEDURE SINDICATO_132.P_SD_OBTENER_GESTION;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_OBTENER_GESTION(
...
IS
 ...
 v_id_log SD_AUX_LOG_ERRORES.id_log%type;
   ...
   v_id NUMBER := 0 ;
   v_idgestion NUMBER := 0;


BEGIN
  v_res := '0';
  
  SELECT COUNT(1) INTO v_cnt FROM SINDICATO_132.SD_GESTION WHERE ESTADO = 'ACTIVO' ORDER BY ID_GESTION DESC ;
  
 
 IF v_cnt = 0 THEN
    v_res := 'No existe gestion ACTIVA consulte TI';
 END IF;
   SELECT ID_GESTION INTO v_idgestion FROM SINDICATO_132.SD_GESTION WHERE ESTADO = 'ACTIVO' ORDER BY ID_GESTION DESC ;
    v_res := v_idgestion;
    p_res := v_res;
EXCEPTION
WHEN OTHERS THEN
...
v_errC:=substr(sqlcode,1,20);
v_errD:=substr(sqlerrm,1,200);
p_grabar_error_bd(v_errC,v_errD,'P_SD_OBTENER_GESTION','P_SD_OBTENER_GESTION','-','-',v_id_log);
p_res :='ERROR. Avise a TI. LOG generado #' || v_id_log;
END;
/


DROP PROCEDURE SINDICATO_132.P_SD_OBTENER_NRO;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_OBTENER_NRO(
p_tabla VARCHAR2,
p_columna VARCHAR2,
--el resultado si es ok toda la operacion '1' y si no te devolvera el mensaje del error
p_res OUT VARCHAR2
...
BEGIN
 ...
 IF v_idgestion = 0 THEN
    v_res := 'No existe gestion activa consulete TI';
 END IF;
 
 IF v_res = '0' THEN
 
  --dbms_output.put_line(v_fecha_hasta);
   v_sql := 'SELECT COALESCE( MAX(' || p_columna || ') , 0) + 1 FROM  SINDICATO_132.'||p_tabla||'  WHERE ID_GESTION = '||v_idgestion;   
            EXECUTE IMMEDIATE (v_sql) INTO v_id;
            
    v_res := v_id;
  --SELECT COALESCE( MAX(NUMERO) , 0 )  + 1  FROM SINDICATO_132.SD_PRESTAMOS_POR_SOCIOS where id_gestion =1;
...
v_errC:=substr(sqlcode,1,20);
v_errD:=substr(sqlerrm,1,200);
p_grabar_error_bd(v_errC,v_errD,'P_SD_OBTENER_NRO','P_SD_OBTENER_NRO','-','-',v_id_log);
p_res :='ERROR. Avise a TI. LOG generado #' || v_id_log;
END;
/


DROP PROCEDURE SINDICATO_132.P_SG_GUARDAR_PERFIL_OPCION;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SG_GUARDAR_PERFIL_OPCION(
 p_id_perfil IN SD_PERFILES_OPCIONES.ID_PERFIL%TYPE,
 p_id_opc  IN SD_PERFILES_OPCIONES.ID_OPC%TYPE,
 p_id_usr   NUMBER,    -- ID del usuario que realiza la operacion
 p_res OUT  VARCHAR2
...
DROP PROCEDURE SINDICATO_132.P_SG_GUARDAR_USUARIO;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SG_GUARDAR_USUARIO(
...
DROP PROCEDURE SINDICATO_132.P_ACT_HOJAS_DETALLES;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_ACT_HOJAS_DETALLES(
p_usr VARCHAR2,
p_res OUT VARCHAR2
)
IS
...
DROP PROCEDURE SINDICATO_132.P_ACT_HOJAS_OLD;
...
--       select * from SD_SOCIO_MOVILES 
    ...
    --SELECT hoj.numero_hoja ,1, soc.id_socio_movil , 0 ,HOJ.FECHA_DE_COMPRA ,hoj.total_hoja ,HOJ.FECHA_DE_USO  , 'migracion de sistema', 'NUEVO','admin', HOJ.FECHA_DE_COMPRA from SINDICATO_132_OLD.HOJA_CONTROL hoj , SD_SOCIO_MOVILES soc WHERE HOJ.ID_MOVIL = SOC.ID_MOVIL
     --select * from  SINDICATO_132_OLD.HOJA_CONTROL  WHERE id_movil  IN (select id_movil from SINDICATO_132_old.movil where id_linea = 1)
      FOR x IN (SELECT hoj.* , SOC.ID_SOCIO_MOVIL FROM  SINDICATO_132_OLD.HOJA_CONTROL hoj , SD_SOCIO_MOVILES soc WHERE HOJ.ID_MOVIL = SOC.ID_MOVIL  and FALTA = 0  ) LOOP
...
DROP PROCEDURE SINDICATO_132.P_ACT_KARDEX_HOJA;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_ACT_KARDEX_HOJA(
p_usr VARCHAR2,
p_res OUT VARCHAR2
)
IS
...
IF v_res =  '0' THEN
    ...
    --  SELECT * FROM SD_SOCIO_MOVILES 
         ...
         SINDICATO_132.P_SD_ACT_KARDEX_HOJA ( x.id_socio_movil,  v_fecha , P_USR, P_RES );
    --  P_SD_CREAR_OBLIGACIONES(x.ID_SOCIO,sysdate,'Creacion Sistema','ADMIN',v_res);
...
DROP PROCEDURE SINDICATO_132.P_ACT_KARDEX_HOJA_FECHA;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_ACT_KARDEX_HOJA_FECHA(
p_usr VARCHAR2,
p_fecha date,
p_res OUT VARCHAR2
)
...
IF v_res =  '0' THEN
    ...
    --  SELECT * FROM SD_SOCIO_MOVILES 
          SELECT MIN(FECHA_COMPRA) INTO v_fecha FROM SD_HOJAS_CONTROL WHERE ID_SOCIO_MOVIL = x.id_socio_movil   ;
         SINDICATO_132.P_SD_ACT_KARDEX_HOJA ( x.id_socio_movil,  p_fecha , P_USR, P_RES );
    --  P_SD_CREAR_OBLIGACIONES(x.ID_SOCIO,sysdate,'Creacion Sistema','ADMIN',v_res);
    --  select * from SD_KARDEX_HOJAS 
      END LOOP;
...
DROP PROCEDURE SINDICATO_132.P_ACT_MORAS;
...
DROP PROCEDURE SINDICATO_132.P_ACT_NRO_HOJAS;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_ACT_NRO_HOJAS(
p_usr VARCHAR2,
p_mes VARCHAR2,
p_res OUT VARCHAR2
)
...
DROP PROCEDURE SINDICATO_132.P_ACT_NRO_PRESTAMO;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_ACT_NRO_PRESTAMO(
p_usr VARCHAR2,
p_res OUT VARCHAR2
)
IS
...
IF v_res =  '0' THEN
      ...
      --FOR x IN (SELECT * FROM  SD_SOCIO_MOVILES  WHERE ID_SOCIO_MOVIL IN (605 , 428 , 318)   ) LOOP
        FOR x IN (SELECT * FROM  SD_PRESTAMOS_POR_SOCIOS WHERE ESTADO <> 'ANULADO'  ORDER BY  FECHA ASC  , ID_PRESTAMO ASC   ) LOOP      
    --  SELECT * FROM SD_SOCIO_MOVILES 
         SINDICATO_132.P_SD_OBTENER_NRO('SD_PRESTAMOS_POR_SOCIOS', 'NUMERO',v_numero );
    --  P_SD_CREAR_OBLIGACIONES(x.ID_SOCIO,sysdate,'Creacion Sistema','ADMIN',v_res);
    --  select * from SD_KARDEX_HOJAS 
       IF x.NUMERO IS NULL THEN
            UPDATE SD_PRESTAMOS_POR_SOCIOS SET NUMERO  = v_numero WHERE ID_PRESTAMO = x.ID_PRESTAMO;
...
DROP PROCEDURE SINDICATO_132.P_ACT_OBLIGACIONES_SOCIO;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_ACT_OBLIGACIONES_SOCIO(
p_usr VARCHAR2,
p_res OUT VARCHAR2
)
IS
...
DROP PROCEDURE SINDICATO_132.P_ACT_OBLIG_SOC_MOV_HOJ;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_ACT_OBLIG_SOC_MOV_HOJ(
p_usr VARCHAR2,
p_res OUT VARCHAR2
)
IS
...
DROP PROCEDURE SINDICATO_132.P_ACT_PAGOS_AHORROS;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_ACT_PAGOS_AHORROS(
p_usr VARCHAR2,
p_res OUT VARCHAR2
)
IS
...
IF v_res =  '0' THEN
        ...
        FOR x IN (SELECT * FROM  SD_SOCIO_MOVILES     ) LOOP      
         SINDICATO_132.P_SD_ACT_PAGOS_SOCIOS ( x.id_socio_movil , P_USR, P_RES );
      END LOOP;
...
DROP PROCEDURE SINDICATO_132.P_ACT_PRESTAMO;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_ACT_PRESTAMO(
p_usr VARCHAR2,
p_res OUT VARCHAR2
)
IS
...
IF v_res =  '0' THEN
    ...
    --  SELECT * FROM SD_SOCIO_MOVILES 
         SINDICATO_132.P_SD_ACT_PLAN_PAGOS(x.ID_PRESTAMO,1,P_RES );
    --  P_SD_CREAR_OBLIGACIONES(x.ID_SOCIO,sysdate,'Creacion Sistema','ADMIN',v_res);
    --  select * from SD_KARDEX_HOJAS 
      END LOOP;
...
DROP PROCEDURE SINDICATO_132.P_AUX_ACT_SECUENCIA;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_AUX_ACT_SECUENCIA(
...
DROP PROCEDURE SINDICATO_132.P_AUX_ACT_SECUENCIA_A;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_AUX_ACT_SECUENCIA_A(
...
BEGIN
  ...
  FOR x IN (SELECT * from ALL_SEQUENCES s WHERE S.SEQUENCE_OWNER = 'SINDICATO_132' AND S.SEQUENCE_NAME LIKE v_criterio)
      LOOP
          ...
          SELECT COUNT(*) INTO v_count  FROM ALL_CONS_COLUMNS WHERE OWNER = 'SINDICATO_132' AND TABLE_NAME = v_tabla AND POSITION = 1 ; 
          IF v_count > 0 THEN
            --recuperamos la columna del primary key de la tabla
            SELECT  COLUMN_NAME INTO v_column_id FROM ALL_CONS_COLUMNS WHERE OWNER = 'SINDICATO_132' AND TABLE_NAME = v_tabla AND  CONSTRAINT_NAME IN (Select constraint_name from user_constraints where table_name = v_tabla AND CONSTRAINT_TYPE = 'P');
...
DROP PROCEDURE SINDICATO_132.P_AUX_REINICIAR_SECUENCIA;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_AUX_REINICIAR_SECUENCIA(
 p_nom_sec VARCHAR2, -- Nombre de la secuencia (debe incluir el ESQUEMA)
 p_res OUT VARCHAR2)
 IS
  v_errc sd_aux_log_errores.cod_error%type;
...
DROP PROCEDURE SINDICATO_132.P_BACKUP_SERVER132;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_BACKUP_SERVER132(
 p_res OUT  VARCHAR2
)
...
BEGIN
  ...
  IF v_res='0' THEN
     ...
     INSERT INTO SD_JOBS_BACKUP (ID_BACKUP , FECHA_REG) VALUES (Q_SD_JOBS_BACKUP.nextval , sysdate);
      ...
      FOR x IN (SELECT * FROM BACKUP_SINDICATO ORDER BY ORDEN DESC) LOOP
          v_sql := 'DELETE FROM '||x.TABLA||'@DBSINDICATO_132_SERVER132';
          EXECUTE IMMEDIATE v_sql ;
           --SELECT * FROM SD_AUTOS@DBSINDICATO_BACKUP
       END LOOP;
       
      FOR x IN (SELECT * FROM BACKUP_SINDICATO ORDER BY ORDEN ASC) LOOP
          v_sql := 'INSERT INTO  '||x.TABLA||'@DBSINDICATO_132_SERVER132 (SELECT * FROM '||x.TABLA ||')';
          EXECUTE IMMEDIATE v_sql ;
           --SELECT * FROM SD_AUTOS@DBSINDICATO_BACKUP
 --          INSERT INTO SD_AUTOS@DBSINDICATO_BACKUP (select * FROM SD_AUTOS)
       END LOOP;
...
DROP PROCEDURE SINDICATO_132.P_EE_SECUENCIA;

CREATE OR REPLACE PROCEDURE SINDICATO_132.p_ee_secuencia( p_cod_tabla varchar2, 
 p_id_usr NUMBER,    -- ID del usuario que realiza la operacion
 p_res OUT NUMBER
)
 /*
...
BEGIN
  ...
  v_sql := 'SELECT SINDICATO_132.q_' || trim(p_cod_tabla) || '.nextval FROM dual';
...
DROP PROCEDURE SINDICATO_132.P_JOBS_BACKUP;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_JOBS_BACKUP
IS
 v_res VARCHAR2(100):='0'; 
BEGIN
   
  SINDICATO_132.P_BACKUP_SERVER132( v_res );
  COMMIT; 
...
DROP PROCEDURE SINDICATO_132.P_SD_ACT_KARDEX_CIERRE_AHORRO;

CREATE OR REPLACE PROCEDURE SINDICATO_132.P_SD_ACT_KARDEX_CIERRE_AHORRO(
