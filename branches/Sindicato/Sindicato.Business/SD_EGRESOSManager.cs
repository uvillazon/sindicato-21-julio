...
{
    public class SD_EGRESOSManager : Repository<SD_EGRESOS>
    {


        public SD_EGRESOSManager(IUnitOfWork uow) : base(uow) { }

        public string GuardarEgreso(SD_EGRESOS ing, string login)
        {
            try
            {
                string result = "";
