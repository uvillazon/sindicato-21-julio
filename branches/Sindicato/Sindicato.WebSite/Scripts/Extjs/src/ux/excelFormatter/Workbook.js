 ...
 */
Ext.define("Ext.ux.excelFormatter.Workbook", {
  ...
  addWorksheet: function(store, config) {
    var worksheet = new Ext.ux.excelFormatter.Worksheet(store, config);
  ...
  addStyle: function(config) {
    var style = new Ext.ux.excelFormatter.Style(config || {});
