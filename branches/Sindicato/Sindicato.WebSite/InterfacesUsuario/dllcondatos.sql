...
/* Formatted on 29/11/2018 18:29:29 (QP5 v5.136.908.31019) */
...
/
SET DEFINE OFF;
Insert into SINDICATO_121.SD_VENTA_HOJAS
   (ID_VENTA, ID_HOJA, FECHA_REG, ID)
 Values
   (4, 3, TO_DATE('11/29/2018 18:28:02', 'MM/DD/YYYY HH24:MI:SS'), 5);
Insert into SINDICATO_121.SD_VENTA_HOJAS
   (ID_VENTA, ID_HOJA, FECHA_REG, ID)
 Values
   (2, 2, TO_DATE('11/29/2018 09:24:36', 'MM/DD/YYYY HH24:MI:SS'), 3);
COMMIT;
...
Insert into SINDICATO_121.SD_USUARIOS
 ...
 Values
   (1, 'ADMIN', 'Administrador2 ', 'admin@importmercado.com', TO_DATE('12/21/2013 21:23:20', 'MM/DD/YYYY HH24:MI:SS'), 
    NULL, 1, 'A', 'admin');
COMMIT;
...
Insert into SINDICATO_121.SD_SOC_MOV_OBLIG
   (ID_SOC_MOV_OBLIG, ID_OBLIGACION, ID_SOCIO_MOVIL, IMPORTE, FECHA_REG, 
    LOGIN)
 Values
   (2, 2, 713, 20, TO_DATE('11/29/2018 09:23:43', 'MM/DD/YYYY HH24:MI:SS'), 
    'admin');
Insert into SINDICATO_121.SD_SOC_MOV_OBLIG
   (ID_SOC_MOV_OBLIG, ID_OBLIGACION, ID_SOCIO_MOVIL, IMPORTE, FECHA_REG, 
    LOGIN)
 Values
   (3, 1, 713, 150, TO_DATE('11/29/2018 09:23:51', 'MM/DD/YYYY HH24:MI:SS'), 
    'admin');
Insert into SINDICATO_121.SD_SOC_MOV_OBLIG
   (ID_SOC_MOV_OBLIG, ID_OBLIGACION, ID_SOCIO_MOVIL, IMPORTE, FECHA_REG, 
    LOGIN)
 Values
   (4, 3, 713, 2, TO_DATE('11/29/2018 09:23:57', 'MM/DD/YYYY HH24:MI:SS'), 
    'admin');
COMMIT;
...
Insert into SINDICATO_121.SD_SOCIO_MOVIL_AUTOS
   (ID_SOCIO_MOVIL_AUTO, ID_SOCIO_MOVIL, ID_AUTO, TIPO, MOTIVO_ALTA, 
    ...
    LOGIN_BAJA, ESTADO)
 Values
   (535, 713, 536, 'PRINCIPAL', 'TEST', 
    NULL, TO_DATE('11/28/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), NULL, TO_DATE('11/28/2018 17:28:57', 'MM/DD/YYYY HH24:MI:SS'), 'admin', 
    NULL, 'ACTIVO');
COMMIT;
...
Insert into SINDICATO_121.SD_SOCIO_MOVILES
   (ID_SOCIO_MOVIL, ID_SOCIO, ID_MOVIL, DESCRIPCION, TIPO_MOVIL, 
    ...
    ESTADO, SALDO, DEBE)
 Values
   (713, 715, 491, 'TET', 'PRIMARIO', 
    TO_DATE('11/28/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), NULL, 'TET', TO_DATE('11/28/2018 17:27:46', 'MM/DD/YYYY HH24:MI:SS'), 2, 
    'ACTIVO', NULL, NULL);
COMMIT;
...
Insert into SINDICATO_121.SD_SOCIOS
   (ID_SOCIO, NRO_SOCIO, NOMBRE, APELLIDO_PATERNO, APELLIDO_MATERNO, 
    ...
    SALDO, DEUDA)
 Values
   (715, 715, 'UBALDO FRANCISCO', 'VILLAZON', 'VILLCA', 
    5190630, 'A', 5190630, 'COCHABAMBA', TO_DATE('06/04/1982 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 
    TO_DATE('11/28/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), NULL, 'QWEQE', 'QWEQEQE', 'CASADO', 
    TO_DATE('11/28/2018 17:27:29', 'MM/DD/YYYY HH24:MI:SS'), 2, 'NUEVO', '4721340', 'QQQ', 
    NULL, NULL);
COMMIT;
...
Insert into SINDICATO_121.SD_MOVILES
 ...
 Values
   (491, 1, 1, 'TEST', TO_DATE('11/28/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 
    NULL, 'TEST', TO_DATE('11/28/2018 17:23:47', 'MM/DD/YYYY HH24:MI:SS'), 'admin', 'ACTIVO');
COMMIT;
...
Insert into SINDICATO_121.SD_MENU_OPCIONES
 ...
 Values
   (36, 'Deudas Socios', 'App.View.DeudasSocios.Principal', 'Deudas de Socios', 'loan-icon', 
    NULL, NULL, 'A', 6);
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
...
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
 Values
   (16, 'Transferencias', 'App.View.Transferencias.Principal', 'Modulo de Transferencias entre cuentas', 'money-icon', 
    NULL, NULL, 'A', 14);
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
...
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
 Values
   (9, 'Ventas Hojas Control', 'App.View.Hojas.Principal', 'Modulo de ventas por Parada de hojas', 'Monitor-icon', 
    NULL, NULL, 'A', 11);
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
...
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
 Values
   (30, 'Kardex Hojas', 'App.View.KardexHojas.Principal', NULL, 'application-settings-icon', 
    NULL, NULL, 'A', 21);
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
 Values
   (24, 'Permisos', 'App.View.Permisos.Principal', 'Administracion de Permisso', 'Monitor-icon', 
    NULL, NULL, 'A', 8);
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
...
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
 Values
   (23, 'Reportes de Todo', 'App.View.Reportes.Reportes', 'Reportes de Ingresos Totales', 'Print-icon', 
    'ReportesIngresos', NULL, 'A', 99);
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
 Values
...
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
 Values
   (26, 'Admin Lineas Moviles', 'App.View.Moviles.Principal', 'Administracion de Lineas Moviles', 'application-settings-icon', 
    NULL, NULL, 'A', 0);
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
 Values
   (27, 'Tipo de Prestamos', 'App.View.TiposPrestamos.Principal', 'Administracion de Tipos de Prestamos', 'coin-delete-icon', 
    NULL, NULL, 'A', 20);
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
 Values
   (28, 'Prestamos Socios', 'App.View.Prestamos.Principal', 'Prestamos de Socios', 'money-icon', 
    NULL, NULL, 'A', 19);
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
 Values
   (29, 'Reportes Socios', 'App.View.Reportes.Reportes', 'Reportes Socios Activos', 'Print-icon', 
    'ReportesSocios', NULL, 'B', 20);
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
 Values
   (21, 'Tipos De Ingresos', 'App.View.TiposIngresos.Principal', 'Modulo de Tipos de Ingresos', 'money-icon', 
    NULL, NULL, 'A', 7);
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
 Values
   (22, 'Ingresos Por Socios', 'App.View.IngresosPorSocios.Principal', 'Modulo de Ingresos Por Socios', 'money-icon', 
    NULL, NULL, 'A', 8);
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
 Values
   (32, 'Tipos de Egresos', 'App.View.TiposEgresos.Principal', 'Administracion de Tipos de Egresos', 'coin-delete-icon', 
    NULL, NULL, 'A', 21);
Insert into SINDICATO_121.SD_MENU_OPCIONES
   (ID_OPC, OPCION, LINK, TOOLTIP, ICONO, 
    ESTILO, ID_PADRE, ESTADO, ORDEN)
 Values
   (33, 'Administracion de Usuarios', 'App.View.Usuarios.Principal', 'Administraciones de Usuarios y Perfiles', 'Groups-Meeting-Dark-icon', 
    NULL, NULL, 'A', 30);
COMMIT;
...
Insert into SINDICATO_121.SD_LINEAS
 ...
 Values
   (1, 121, 'Linea 121', TO_DATE('01/01/2014 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), NULL, 
    'linea', TO_DATE('01/01/2014 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 1, 'A', 2);
COMMIT;

SET DEFINE OFF;
Insert into SINDICATO_121.SD_KARDEX_HOJAS
   (ID_KARDEX, ID_SOCIO_MOVIL, MES, CANT_HOJAS, CANT_REGULACIONES, 
    CANT_HOJAS_OBLIG, LOGIN, FECHA_REG, DEBE)
 Values
   (2, 713, TO_DATE('11/01/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 2, 0, 
    1, 'admin', TO_DATE('11/29/2018 09:24:30', 'MM/DD/YYYY HH24:MI:SS'), 0);
COMMIT;

SET DEFINE OFF;
Insert into SINDICATO_121.SD_KARDEX_EFECTIVO
   (ID_KARDEX, ID_CAJA, ID_OPERACION, OPERACION, FECHA, 
    DETALLE, INGRESO, EGRESO, SALDO, LOGIN, 
    FECHA_REG)
 Values
   (5, 3, 3, 'VENTA HOJA', TO_DATE('11/29/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 
    'PRODEPORTE - Movil : 1', 20, 0, 40, 'admin', 
    TO_DATE('11/29/2018 18:28:02', 'MM/DD/YYYY HH24:MI:SS'));
Insert into SINDICATO_121.SD_KARDEX_EFECTIVO
   (ID_KARDEX, ID_CAJA, ID_OPERACION, OPERACION, FECHA, 
    DETALLE, INGRESO, EGRESO, SALDO, LOGIN, 
    FECHA_REG)
 Values
   (6, 1, 3, 'VENTA HOJA', TO_DATE('11/29/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 
    'APORTE SINDICATO - Movil : 1', 150, 0, 300, 'admin', 
    TO_DATE('11/29/2018 18:28:02', 'MM/DD/YYYY HH24:MI:SS'));
Insert into SINDICATO_121.SD_KARDEX_EFECTIVO
   (ID_KARDEX, ID_CAJA, ID_OPERACION, OPERACION, FECHA, 
    DETALLE, INGRESO, EGRESO, SALDO, LOGIN, 
    FECHA_REG)
 Values
   (7, 4, 3, 'VENTA HOJA', TO_DATE('11/29/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 
    'APORTE CONTROLES - Movil : 1', 2, 0, 4, 'admin', 
    TO_DATE('11/29/2018 18:28:02', 'MM/DD/YYYY HH24:MI:SS'));
Insert into SINDICATO_121.SD_KARDEX_EFECTIVO
   (ID_KARDEX, ID_CAJA, ID_OPERACION, OPERACION, FECHA, 
    DETALLE, INGRESO, EGRESO, SALDO, LOGIN, 
    FECHA_REG)
 Values
   (2, 3, 2, 'VENTA HOJA', TO_DATE('11/29/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 
    'PRODEPORTE - Movil : 1', 20, 0, 20, 'admin', 
    TO_DATE('11/29/2018 09:24:36', 'MM/DD/YYYY HH24:MI:SS'));
Insert into SINDICATO_121.SD_KARDEX_EFECTIVO
   (ID_KARDEX, ID_CAJA, ID_OPERACION, OPERACION, FECHA, 
    DETALLE, INGRESO, EGRESO, SALDO, LOGIN, 
    FECHA_REG)
 Values
   (3, 1, 2, 'VENTA HOJA', TO_DATE('11/29/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 
    'APORTE SINDICATO - Movil : 1', 150, 0, 150, 'admin', 
    TO_DATE('11/29/2018 09:24:36', 'MM/DD/YYYY HH24:MI:SS'));
Insert into SINDICATO_121.SD_KARDEX_EFECTIVO
   (ID_KARDEX, ID_CAJA, ID_OPERACION, OPERACION, FECHA, 
    DETALLE, INGRESO, EGRESO, SALDO, LOGIN, 
    FECHA_REG)
 Values
   (4, 4, 2, 'VENTA HOJA', TO_DATE('11/29/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 
    'APORTE CONTROLES - Movil : 1', 2, 0, 2, 'admin', 
    TO_DATE('11/29/2018 09:24:36', 'MM/DD/YYYY HH24:MI:SS'));
COMMIT;

SET DEFINE OFF;
Insert into SINDICATO_121.SD_HOJAS_CONTROL
   (ID_HOJA, ID_PARADA, ID_SOCIO_MOVIL, ID_CHOFER, NRO_HOJA, 
    FECHA_COMPRA, MONTO, FECHA_USO, OBSERVACION, ESTADO, 
    LOGIN, FECHA_REG)
 Values
   (3, 1, 713, NULL, 2, 
    TO_DATE('11/29/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 172, TO_DATE('11/29/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'COMPRA', 'NUEVO', 
    'admin', TO_DATE('11/29/2018 18:28:02', 'MM/DD/YYYY HH24:MI:SS'));
Insert into SINDICATO_121.SD_HOJAS_CONTROL
   (ID_HOJA, ID_PARADA, ID_SOCIO_MOVIL, ID_CHOFER, NRO_HOJA, 
    FECHA_COMPRA, MONTO, FECHA_USO, OBSERVACION, ESTADO, 
    LOGIN, FECHA_REG)
 Values
   (2, 1, 713, NULL, 1, 
    TO_DATE('11/29/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 172, TO_DATE('11/29/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'COMPRA', 'NUEVO', 
    'admin', TO_DATE('11/29/2018 09:24:36', 'MM/DD/YYYY HH24:MI:SS'));
COMMIT;

SET DEFINE OFF;
Insert into SINDICATO_121.SD_DEUDAS_SOCIOS
   (ID_DEUDA, MOTIVO, FECHA, IMPORTE, OBSERVACION, 
    ESTADO, LOGIN_USR, FECHA_REG, ID_CAJA)
 Values
   (1, 'FALTANTES A REUNION 22/10/2018', TO_DATE('11/29/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 100, 'REUNION TEST', 
    'ACTIVO', 'admin', TO_DATE('11/29/2018 18:12:44', 'MM/DD/YYYY HH24:MI:SS'), 1);
COMMIT;

SET DEFINE OFF;
Insert into SINDICATO_121.SD_DETALLES_HOJAS_CONTROL
   (ID_DETALLE, ID_HOJA, ID_CAJA, OBLIGACION, IMPORTE, 
    LOGIN, FECHA_REG)
 Values
   (5, 3, 3, 'PRODEPORTE', 20, 
    'admin', TO_DATE('11/29/2018 18:28:02', 'MM/DD/YYYY HH24:MI:SS'));
Insert into SINDICATO_121.SD_DETALLES_HOJAS_CONTROL
   (ID_DETALLE, ID_HOJA, ID_CAJA, OBLIGACION, IMPORTE, 
    LOGIN, FECHA_REG)
 Values
   (6, 3, 1, 'APORTE SINDICATO', 150, 
    'admin', TO_DATE('11/29/2018 18:28:02', 'MM/DD/YYYY HH24:MI:SS'));
Insert into SINDICATO_121.SD_DETALLES_HOJAS_CONTROL
   (ID_DETALLE, ID_HOJA, ID_CAJA, OBLIGACION, IMPORTE, 
    LOGIN, FECHA_REG)
 Values
   (7, 3, 4, 'APORTE CONTROLES', 2, 
    'admin', TO_DATE('11/29/2018 18:28:02', 'MM/DD/YYYY HH24:MI:SS'));
Insert into SINDICATO_121.SD_DETALLES_HOJAS_CONTROL
   (ID_DETALLE, ID_HOJA, ID_CAJA, OBLIGACION, IMPORTE, 
    LOGIN, FECHA_REG)
...
Insert into SINDICATO_121.SD_DETALLES_HOJAS_CONTROL
   (ID_DETALLE, ID_HOJA, ID_CAJA, OBLIGACION, IMPORTE, 
    LOGIN, FECHA_REG)
 Values
   (3, 2, 1, 'APORTE SINDICATO', 150, 
    'admin', TO_DATE('11/29/2018 09:24:36', 'MM/DD/YYYY HH24:MI:SS'));
Insert into SINDICATO_121.SD_DETALLES_HOJAS_CONTROL
   (ID_DETALLE, ID_HOJA, ID_CAJA, OBLIGACION, IMPORTE, 
    LOGIN, FECHA_REG)
 Values
   (4, 2, 4, 'APORTE CONTROLES', 2, 
    'admin', TO_DATE('11/29/2018 09:24:36', 'MM/DD/YYYY HH24:MI:SS'));
COMMIT;
...
Insert into SINDICATO_121.SD_CAJAS
 ...
 Values
   (1, '1000', 'HACIENDA', '123456', 'CAJA DE HACIENDA', 
    300, 'admin', TO_DATE('03/03/2015 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'BOLIVIANOS');
Insert into SINDICATO_121.SD_CAJAS
   (ID_CAJA, CODIGO, NOMBRE, NRO_CUENTA, DESCRIPCION, 
    SALDO, LOGIN, FECHA_REG, MONEDA)
 Values
...
Insert into SINDICATO_121.SD_CAJAS
 ...
 Values
   (3, '3000', 'PRO-DEPORTE', '0', 'CAJA PRO-DEPORTE', 
    40, 'admin', TO_DATE('05/14/2016 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'BOLIVIANOS');
Insert into SINDICATO_121.SD_CAJAS
   (ID_CAJA, CODIGO, NOMBRE, NRO_CUENTA, DESCRIPCION, 
    SALDO, LOGIN, FECHA_REG, MONEDA)
 Values
   (4, '4000', 'CONTROLES', '0', 'CAJA CONTROLES', 
    4, 'admin', TO_DATE('05/14/2016 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'BOLIVIANOS');
Insert into SINDICATO_121.SD_CAJAS
   (ID_CAJA, CODIGO, NOMBRE, NRO_CUENTA, DESCRIPCION, 
    SALDO, LOGIN, FECHA_REG, MONEDA)
 Values
...
Insert into SINDICATO_121.SD_AUTOS
 ...
 Values
   (536, 'VAGONETA', 'ROJO', 'TOYOTA', 'ROJO', 
    'XXX-1234', 'QWEQWE', NULL, 'TET', TO_DATE('11/28/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 
    NULL, TO_DATE('11/28/2018 17:28:43', 'MM/DD/YYYY HH24:MI:SS'), 'admin');
COMMIT;
