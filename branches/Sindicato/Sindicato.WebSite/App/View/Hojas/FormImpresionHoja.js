Ext.define("App.View.Hojas.FormImpresionHoja", {
    extend: "App.Config.Abstract.Form",
    columns: 2,
    title: 'Datos de Impresion de Hojas de Control',
    listeners: {
    ...
    ImprimirHojas: function (id) {
        ...
        var ruta = fn.ObtenerUrlReportPDF("ReporteImpresionHojas", "ID_IMPRESION=" + id);
        //window.open(ruta);
