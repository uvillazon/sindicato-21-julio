Ext.define("App.View.Sgaf.View.GridImportarFactura", {
    ...
    dockedItems: [{
        ...
        items: [
            ...
            {
                itemId: 'btn_select_error',
                text: 'Seleccionar Errores',
                iconCls: 'cross',
            },
            {
                itemId: 'btn_eliminar_seleccionado',
    ...
    viewConfig: {
        getRowClass: function (record, rowIndex, rowParams, store) {
            if (record.get('ID_STATUS') === 1) {
                return 'Sgaf-sinerror';
            }
            if (record.get('ID_STATUS') === 2) {
                return 'Sgaf-conerror';
            }
            if (record.get('ID_STATUS') === 3) {
                return 'Sgaf-conadvertencia';
            }
            return "";
        }
    },
    ...
    columns: [
        ...
        { text: 'IdProveedor', dataIndex: 'IDPROVEEDOR', width: 80, sortable: true },
        ...
        { text: 'Observaciones', dataIndex: 'OBSERVACIONES', width: 300, sortable: true },
