Ext.define("App.View.CierresParada.Principal", {
    ...
    CargarComponentes: function () {
        ...
        me.grid = Ext.create('App.View.CierresParada.GridCierres', {
            region: 'west',
            width: '50%',
            //fbarmenu: me.toolbar,
        ...
        me.form = Ext.create("App.View.CierresParada.FormCierre", {
            region: 'center',
            width: '50%',
            columns: 2,
            modoConsulta: true,
    ...
    FormCrearCierre: function () {
        ...
        var form = Ext.create("App.View.CierresParada.FormCierre", {
