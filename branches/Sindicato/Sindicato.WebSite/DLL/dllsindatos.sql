...
=======
16/12/2015
ALTER TABLE SINDICATO.SD_DETALLES_VENTA_HOJAS
 DROP PRIMARY KEY CASCADE;

DROP TABLE SINDICATO.SD_DETALLES_VENTA_HOJAS CASCADE CONSTRAINTS;

CREATE TABLE SINDICATO.SD_DETALLES_VENTA_HOJAS
(
  ID_DETALLE        NUMBER(7)                   NOT NULL,
  ID_VENTA          NUMBER(7)                   NOT NULL,
  ID_SOC_MOV_OBLIG  NUMBER(7)                   NOT NULL,
...
CREATE UNIQUE INDEX SINDICATO.SD_DETALLES_VENTA_HOJAS_PK ON SINDICATO.SD_DETALLES_VENTA_HOJAS
(ID_DETALLE)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
ALTER TABLE SINDICATO.SD_DETALLES_VENTA_HOJAS ADD (
  CONSTRAINT SD_DETALLES_VENTA_HOJAS_PK
 PRIMARY KEY
 (ID_DETALLE)
    USING INDEX 
    TABLESPACE USERS
...
ALTER TABLE SINDICATO.SD_DETALLES_VENTA_HOJAS ADD (
  CONSTRAINT SD_DETALLES_VENTA_HOJAS_R01 
 FOREIGN KEY (ID_VENTA) 
 REFERENCES SINDICATO.SD_VENTA_HOJAS (ID_VENTA),
  CONSTRAINT SD_DETALLES_VENTA_HOJAS_R02 
 FOREIGN KEY (ID_SOC_MOV_OBLIG) 
 REFERENCES SINDICATO.SD_SOC_MOV_OBLIG (ID_SOC_MOV_OBLIG));
>>>>>>> b18842db4f6ec52aa0d6518cbaf9aac0921c3935
