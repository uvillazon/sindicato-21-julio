...
/* Formatted on 08/04/2016 15:56:24 (QP5 v5.136.908.31019) */
...
DROP SEQUENCE SINDICATO_132.Q_SD_INGRESOS_SOCIOS;

CREATE SEQUENCE SINDICATO_132.Q_SD_INGRESOS_SOCIOS
  START WITH 1
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
BEGIN
  ...
  IF v_res='0' THEN
      ...
      VALUES(Q_SD_IMPRESIONES.nextval, p_nro_inicio, p_nro_fin, p_observacion, sysdate, p_login_usr);
...
IF v_res =  '0' THEN
        ...
        WHILE v_cnt < p_cantidad LOOP
            ...
            INSERT INTO SD_KARDEX_EFECTIVO (ID_KARDEX ,ID_CAJA ,ID_OPERACION ,OPERACION ,FECHA, DETALLE ,INGRESO ,EGRESO, SALDO, LOGIN, FECHA_REG )
            (
               SELECT Q_SD_KARDEX_EFECTIVO.nextval , ob.id_caja ,  v_id_hoja , 'VENTA HOJA',p_fecha_compra , ob.obligacion ,ob.IMPORTE_DEFECTO , 0 , 0 , p_usr , sysdate  from SD_SOC_MOV_OBLIG soc , SD_OBLIGACIONES_HOJA  ob where SOC.ID_OBLIGACION =  OB.ID_OBLIGACION AND id_socio_movil = p_ID_SOCIO_MOVIL
            );
            v_cnt := v_cnt + 1;
            v_numero := v_numero + 1;
...
IF p_id_tipo =  0 THEN
    ...
    IF v_res='0' THEN
        ...
        INSERT INTO SINDICATO_132.SD_TIPOS_INGRESOS_SOCIO  (ID_TIPO, ID_CAJA ,NOMBRE, OBSERVACION ,ESTADO, MONEDA ,IMPORTE, FECHA_REG, LOGIN_USR   )
