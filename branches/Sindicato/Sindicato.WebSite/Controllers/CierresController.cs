    ...
    public class CierresController : Controller
    {
        ...
        public ActionResult ObtenerDetallesCierreCajaPaginados(PagingInfo paginacion, FiltrosModel<SociosModel> filtros, SociosModel entidad)
        {
            ...
            var formatData = socios.Select(x => new
            {
                ...
                ESTADO = x.ESTADO,
                SALDO = x.SALDO,
                SALDO_ANTERIOR = x.SD_CIERRES_CAJAS.SD_CIERRES_CAJAS2 == null ? 0 : x.SD_CIERRES_CAJAS.SD_CIERRES_CAJAS2.SD_DETALLE_CIERRES_CAJA.FirstOrDefault(y => y.ID_CAJA == x.ID_CAJA) == null ? 0 : x.SD_CIERRES_CAJAS.SD_CIERRES_CAJAS2.SD_DETALLE_CIERRES_CAJA.FirstOrDefault(y => y.ID_CAJA == x.ID_CAJA).SALDO_ANTERIOR,
                TOTAL = x.SALDO + (x.SD_CIERRES_CAJAS.SD_CIERRES_CAJAS2 == null ? 0 :  x.SD_CIERRES_CAJAS.SD_CIERRES_CAJAS2.SD_DETALLE_CIERRES_CAJA.FirstOrDefault(y => y.ID_CAJA == x.ID_CAJA) == null ? 0 : x.SD_CIERRES_CAJAS.SD_CIERRES_CAJAS2.SD_DETALLE_CIERRES_CAJA.FirstOrDefault(y => y.ID_CAJA == x.ID_CAJA).SALDO_ANTERIOR),
