...
//var DEFAULT_URL = 'http://elfsgc02:8080/jasperserver/rest_v2/reports/reports/SGLABMED/rpt_entrega_recepcion.pdf?j_username=jasperadmin&j_password=jasperadmin&ignorePagination=false&id_sol=4&nombre=ubaldo';
...
function webViewerInitialized() {
    var queryString = document.location.search.substring(6, document.location.search.length);
     console.log(queryString);
    var params = parseQueryString(queryString);
    // console.log(DEFAULT_URL);
    var file = queryString;// : DEFAULT_URL;
     console.log(file);
