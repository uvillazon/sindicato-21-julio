...
{
    public partial class SD_KARDEX_HOJAS
    {
        public static Expression<Func<SD_KARDEX_HOJAS, bool>> Contiene(string contiene)
        {
            ...
            try
            {
                ...
                return m => contiene == null || id.Contains(m.SD_SOCIO_MOVILES.SD_MOVILES.NRO_MOVIL);
            }
