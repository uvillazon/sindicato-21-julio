...
{
    public partial class SD_RETIRO_SOCIO_MOVIL
    {
        public static Expression<Func<SD_RETIRO_SOCIO_MOVIL, bool>> Contiene(string contiene)
        {
            ...
            try
            {
                ...
                return m => contiene == null || id.Contains(m.ID_RETIRO) || id.Contains(m.SD_SOCIO_MOVILES.SD_MOVILES.NRO_MOVIL);
            }
