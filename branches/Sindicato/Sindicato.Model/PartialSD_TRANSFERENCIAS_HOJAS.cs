...
{
    public partial class SD_TRANSFERENCIAS_HOJAS
    {
        public static Expression<Func<SD_TRANSFERENCIAS_HOJAS, bool>> Contiene(string contiene)
        {
            ...
            try
            {
                ...
                return m => contiene == null || id.Contains(m.ID_TRANSF) || id.Contains(m.SD_SOCIO_MOVILES.SD_MOVILES.NRO_MOVIL);
            }
