...
{
    public partial class SD_PERMISOS
    {
        public static Expression<Func<SD_PERMISOS, bool>> Contiene(string contiene)
        {
            ...
            try
            {
                ...
                return m => contiene == null || id.Contains(m.ID_PERMISO) || id.Contains(m.SD_SOCIO_MOVILES.SD_MOVILES.NRO_MOVIL);
            }
