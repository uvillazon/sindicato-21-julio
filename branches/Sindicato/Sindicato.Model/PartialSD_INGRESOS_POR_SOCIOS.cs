...
{
    public partial class SD_INGRESOS_POR_SOCIOS
    {
        public static Expression<Func<SD_INGRESOS_POR_SOCIOS, bool>> Contiene(string contiene)
        {
            ...
            try
            {
                ...
                return m => contiene == null || id.Contains(m.ID_INGRESO) || id.Contains(m.SD_SOCIO_MOVILES.SD_MOVILES.NRO_MOVIL);
            }
